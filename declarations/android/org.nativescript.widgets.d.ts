        ...
        module widgets {
            ...
            export module Async {
                ...
                export module File {
                    ...
                    export function write(path: string, content: number[], callback: CompleteCallback, context: any);
                }
            ...
            export class BorderDrawable extends android.graphics.drawable.ColorDrawable {
                ...
                public refresh(
                    ...
                    backgroundPositionParsedCSSValues: CSSValue[],
                    backgroundSize: string,
                    backgroundSizeParsedCSSValues: CSSValue[],
                );
            ...
            export class GridLayout extends LayoutBase {
                ...
                public getColumns(): ItemSpec[];

                public getRows(): ItemSpec[];
            }
            ...
            export class TabLayout extends android.widget.HorizontalScrollView {
                ...
                setSelectedIndicatorColors(color: number[]): void;

                getSelectedIndicatorColors(): number[];
                ...
                setItems(items: TabItemSpec[], viewPager: androidx.viewpager.widget.ViewPager): void;
            ...
            export class BottomNavigationBar extends android.widget.LinearLayout {
                ...
                setItems(items: TabItemSpec[]): void;
    ...
    export module nativescript {
        export module widgets {
            export class Utils {
                ...
                public static loadImageAsync(param0: android.content.Context, param1: string, param2: string, param3: number, param4: number, param5: org.nativescript.widgets.Utils.AsyncImageCallback): void;

                public static drawBoxShadow(param0: android.view.View, param1: string): void;

                public static saveToFileAsync(param0: android.graphics.Bitmap, param1: string, param2: string, param3: number, param4: org.nativescript.widgets.Utils.AsyncImageCallback): void;

                public static toBase64StringAsync(param0: android.graphics.Bitmap, param1: string, param2: number, param3: org.nativescript.widgets.Utils.AsyncImageCallback): void;

                public static resizeAsync(param0: android.graphics.Bitmap, param1: number, param2: string, param3: org.nativescript.widgets.Utils.AsyncImageCallback): void;
