...
/**
 * @Source com.stardust.autojs.runtime.api.Device
 */

declare namespace Internal {
    class Device extends com.stardust.autojs.runtime.api.Device {
        /**
         ...
         * @see com.stardust.util.ScreenMetrics
         */
        width: number;
        /**
         * @example
         ...
         * @example
         * console.log(device.serial); // e.g. BH900DK9EL
         * @example Source code summary (zh-CN: 源代码摘要)
         ...
         * @see com.stardust.pio.PFiles
         * @see com.stardust.pio.UncheckedIOException
