// Type definitions for Auto.js internal module io
//
...
/**
 * @Source %autojs%/assets/modules/__io__.js
 */

declare namespace Internal {
    class Files extends com.stardust.autojs.runtime.api.Files {
        /**
         * @example
         ...
         * };
         * @see com.stardust.autojs.runtime.api.Files.join
         */
         ...
         *     }));
         * }
         * @see com.stardust.util.Func1
         */
        listDir(path: string, filter?: com.stardust.util.Func1<string, boolean>): string[];
         ...
         * }
         * @see com.stardust.pio.PFileInterface
         * @see com.stardust.pio.PReadableTextFile
         * @see com.stardust.pio.PWritableTextFile
         * @see java.nio.charset.Charset
         */
        open(path: string, mode?: 'r', encoding?: StandardCharsets, bufferSize?: number): com.stardust.pio.PReadableTextFile;
         ...
         * @see java.nio.charset.Charset
         */
        open(path: string, mode: 'w' | 'a', encoding?: StandardCharsets, bufferSize?: number): com.stardust.pio.PWritableTextFile;
 ...
 *     }
 * };
 * @see com.stardust.autojs.runtime.api.Files.open
 */
declare function open(path: string, mode?: 'r', encoding?: StandardCharsets, bufferSize?: number): com.stardust.pio.PReadableTextFile;
/**
 * @example Source code summary (zh-CN: 源代码摘要)
 * const fs = __runtime__.files;
 * const files = Object.create(fs);
 ...
 * @see com.stardust.autojs.runtime.api.Files.open
 */
declare function open(path: string, mode: 'w' | 'a', encoding?: StandardCharsets, bufferSize?: number): com.stardust.pio.PWritableTextFile;