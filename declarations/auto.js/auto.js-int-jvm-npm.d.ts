// Type definitions for Auto.js internal module jvm-npm
//
...
/**
 * @Source %autojs%/assets/modules/jvm-npm.js
 */
...
declare namespace Require {
    ...
    type InternalModule = '__app__.js' | '__automator__.js' | '__bridges__.js' | '__console__.js' | '__continuation__.js' | '__dialogs__.js' | '__engines__.js' | '__events__.js' | '__floaty__.js' | '__globals__.js' | '__http__.js' | '__images__.js' | '__io__.js' | '__java_util__.js' | '__media__.js' | '__plugins__.js' | '__RootAutomator__.js' | '__selector__.js' | '__sensors__.js' | '__shell__.js' | '__storages__.js' | '__threads__.js' | '__timers__.js' | '__ui__.js' | '__unit_test__.js' | '__util__.js' | '__web__.js' | 'array-observe.min.js' | 'jvm-npm.js' | 'object-observe-lite.min.js' | 'promise.js' | 'result_adapter.js' | '__app__' | '__automator__' | '__bridges__' | '__console__' | '__continuation__' | '__dialogs__' | '__engines__' | '__events__' | '__floaty__' | '__globals__' | '__http__' | '__images__' | '__io__' | '__java_util__' | '__media__' | '__plugins__' | '__web__' | '__RootAutomator__' | 'promise' | '__selector__' | '__sensors__' | '__shell__' | '__storages__' | '__threads__' | '__timers__' | '__ui__' | '__unit_test__' | '__util__' | 'array-observe.min' | 'jvm-npm' | 'object-observe-lite.min' | 'result_adapter';
}
