// Type definitions for Auto.js internal module shell
//
...
/**
 * @Source %autojs%/assets/modules/__shell__.js
 */

declare namespace Internal {
    class Shell extends com.stardust.autojs.runtime.api.AbstractShell.Result {
        /**
         * @example Source code summary (zh-CN: 源代码摘要)
         * new ProcessShell(isRoot).waitFor();
         */
        code: 0 | number;
        /**
         * @example Source code summary (zh-CN: 源代码摘要)
         * new ProcessShell(isRoot).getSucceedOutput().toString();
         */
        result: string;
        /**
         * @example Source code summary (zh-CN: 源代码摘要)
         * new ProcessShell(isRoot).getErrorOutput().toString();
         */
        error: string;
    }
}
 ...
 * };
 * @see com.stardust.autojs.runtime.api.AbstractShell.SetScreenMetrics
 */
 ...
 * };
 * @see com.stardust.autojs.runtime.api.AbstractShell.Tap
 */
 ...
 *     }
 * };
 * @see com.stardust.autojs.runtime.api.AbstractShell.Swipe
 */
 ...
 * };
 * @see com.stardust.autojs.runtime.api.AbstractShell.Screencap
 */
 ...
 * };
 * @see com.stardust.autojs.runtime.api.AbstractShell.KeyCode
 ...
 * };
 * @see com.stardust.autojs.runtime.api.AbstractShell.Text
 */
