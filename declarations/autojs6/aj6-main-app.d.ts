		...
		export namespace autojs {
			export namespace engine {
				export class NodePluginScriptRequest {
					...
					public readonly childProcessEnabled: boolean;
					public readonly dynamicImportEnabled: boolean;
			...
			export namespace script {
				...
				export namespace ScriptLaunchSourceFactory {
					export class Launch {
						...
						public component2(): string;
						public copy(source: __javaRoots.orgRoot.autojs.autojs.script.ScriptSource, workingDirectory: string): __javaRoots.orgRoot.autojs.autojs.script.ScriptLaunchSourceFactory.Launch;
