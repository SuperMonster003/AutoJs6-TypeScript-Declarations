...
declare module androidx {
	export module webkit {
		export class BlockingStartUpLocation extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.BlockingStartUpLocation>;
			/**
			 * Constructs a new instance of the androidx.webkit.BlockingStartUpLocation interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
			 */
			public constructor(implementation: {
				getStackInformation(): string;
			});
			public constructor();
			public getStackInformation(): string;
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class NoVarySearchHeader extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.NoVarySearchHeader>;
			public varyOnKeyOrder: boolean;
			public ignoreDifferencesInParameters: boolean;
			public ignoredQueryParameters: java.util.List<string>;
			public consideredQueryParameters: java.util.List<string>;
			public static alwaysVaryHeader(): androidx.webkit.NoVarySearchHeader;
			public static varyExcept(varyOnOrdering: boolean, ignoredQueryParameters: java.util.List<string>): androidx.webkit.NoVarySearchHeader;
			public static neverVaryExcept(varyOnOrdering: boolean, consideredQueryParameters: java.util.List<string>): androidx.webkit.NoVarySearchHeader;
			public static neverVaryHeader(): androidx.webkit.NoVarySearchHeader;
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class OutcomeReceiverCompat<T, E>  extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.OutcomeReceiverCompat<any,any>>;
			/**
			 * Constructs a new instance of the androidx.webkit.OutcomeReceiverCompat<any,any> interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
			 */
			public constructor(implementation: {
...
declare module androidx {
	export module webkit {
		export class PrefetchException extends java.lang.Exception {
			public static class: java.lang.Class<androidx.webkit.PrefetchException>;
...
declare module androidx {
	export module webkit {
		export class PrefetchNetworkException extends androidx.webkit.PrefetchException {
			public static class: java.lang.Class<androidx.webkit.PrefetchNetworkException>;
			public static NO_HTTP_RESPONSE_STATUS_CODE: number;
			public httpResponseStatusCode: number;
			public constructor(httpResponseStatusCode: number);
			public constructor(message: string, cause: java.lang.Throwable);
			public constructor(error: string);
			public constructor(cause: java.lang.Throwable);
			public constructor(message: string, cause: java.lang.Throwable, enableSuppression: boolean, writableStackTrace: boolean);
			public constructor(error: string, httpResponseStatusCode: number);
			public constructor();
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class PrerenderException extends java.lang.Exception {
			public static class: java.lang.Class<androidx.webkit.PrerenderException>;
			public constructor(message: string);
			public constructor(message: string, cause: java.lang.Throwable);
			public constructor(cause: java.lang.Throwable);
			public constructor(message: string, cause: java.lang.Throwable, enableSuppression: boolean, writableStackTrace: boolean);
...
declare module androidx {
	export module webkit {
		export class PrerenderOperationCallback extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.PrerenderOperationCallback>;
			/**
			 * Constructs a new instance of the androidx.webkit.PrerenderOperationCallback interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
			 */
			public constructor(implementation: {
				onPrerenderActivated(): void;
				onError(param0: androidx.webkit.PrerenderException): void;
			});
			public constructor();
			public onError(param0: androidx.webkit.PrerenderException): void;
			public onPrerenderActivated(): void;
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class ProcessGlobalConfig extends java.lang.Object {
			...
			public constructor();
			public setPartitionedCookiesEnabled(context: android.content.Context, isEnabled: boolean): androidx.webkit.ProcessGlobalConfig;
...
declare module androidx {
	export module webkit {
		export class Profile extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.Profile>;
			/**
			 * Constructs a new instance of the androidx.webkit.Profile interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
			 */
			public constructor(implementation: {
				getName(): string;
				getCookieManager(): android.webkit.CookieManager;
				getWebStorage(): android.webkit.WebStorage;
				getGeolocationPermissions(): android.webkit.GeolocationPermissions;
				getServiceWorkerController(): android.webkit.ServiceWorkerController;
				prefetchUrlAsync(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
				prefetchUrlAsync(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: androidx.webkit.SpeculativeLoadingParameters, param4: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
				clearPrefetchAsync(param0: string, param1: java.util.concurrent.Executor, param2: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
				setSpeculativeLoadingConfig(param0: androidx.webkit.SpeculativeLoadingConfig): void;
			});
			public constructor();
			public static DEFAULT_PROFILE_NAME: string;
			public prefetchUrlAsync(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: androidx.webkit.SpeculativeLoadingParameters, param4: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
			public getName(): string;
			public setSpeculativeLoadingConfig(param0: androidx.webkit.SpeculativeLoadingConfig): void;
			public getServiceWorkerController(): android.webkit.ServiceWorkerController;
			public prefetchUrlAsync(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
			public getCookieManager(): android.webkit.CookieManager;
			public getGeolocationPermissions(): android.webkit.GeolocationPermissions;
			public clearPrefetchAsync(param0: string, param1: java.util.concurrent.Executor, param2: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
			public getWebStorage(): android.webkit.WebStorage;
		}
		export module Profile {
			export class ExperimentalUrlPrefetch extends java.lang.Object implements java.lang.annotation.Annotation {
				public static class: java.lang.Class<androidx.webkit.Profile.ExperimentalUrlPrefetch>;
				/**
				 * Constructs a new instance of the androidx.webkit.Profile$ExperimentalUrlPrefetch interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
...
declare module androidx {
	export module webkit {
		export class ProfileStore extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.ProfileStore>;
			/**
			 * Constructs a new instance of the androidx.webkit.ProfileStore interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
			 */
			public constructor(implementation: {
				getInstance(): androidx.webkit.ProfileStore;
				getOrCreateProfile(param0: string): androidx.webkit.Profile;
				getProfile(param0: string): androidx.webkit.Profile;
				getAllProfileNames(): java.util.List<string>;
				deleteProfile(param0: string): boolean;
			});
			public constructor();
			public getProfile(param0: string): androidx.webkit.Profile;
			public deleteProfile(param0: string): boolean;
			public getOrCreateProfile(param0: string): androidx.webkit.Profile;
			public getAllProfileNames(): java.util.List<string>;
			public static getInstance(): androidx.webkit.ProfileStore;
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class ScriptHandler extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.ScriptHandler>;
			/**
			 * Constructs a new instance of the androidx.webkit.ScriptHandler interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
			 */
			public constructor(implementation: {
				remove(): void;
			});
...
declare module androidx {
	export module webkit {
		export class SpeculativeLoadingConfig extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.SpeculativeLoadingConfig>;
			public static ABSOLUTE_MAX_PREFETCHES: number;
			public static DEFAULT_TTL_SECS: number;
			public static DEFAULT_MAX_PREFETCHES: number;
			public getMaxPrefetches(): number;
			public getPrefetchTtlSeconds(): number;
		}
		export module SpeculativeLoadingConfig {
			export class Builder extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.SpeculativeLoadingConfig.Builder>;
				public setPrefetchTtlSeconds(ttlSeconds: number): androidx.webkit.SpeculativeLoadingConfig.Builder;
				public setMaxPrefetches(max: number): androidx.webkit.SpeculativeLoadingConfig.Builder;
				public build(): androidx.webkit.SpeculativeLoadingConfig;
				public constructor();
			}
		}
	}
...
declare module androidx {
	export module webkit {
		export class SpeculativeLoadingParameters extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.SpeculativeLoadingParameters>;
			public getAdditionalHeaders(): java.util.Map<string,string>;
			public isJavaScriptEnabled(): boolean;
			public getExpectedNoVarySearchData(): androidx.webkit.NoVarySearchHeader;
		}
		export module SpeculativeLoadingParameters {
			export class Builder extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.SpeculativeLoadingParameters.Builder>;
				public addAdditionalHeader(key: string, value: string): androidx.webkit.SpeculativeLoadingParameters.Builder;
				public setExpectedNoVarySearchData(expectedNoVarySearchHeader: androidx.webkit.NoVarySearchHeader): androidx.webkit.SpeculativeLoadingParameters.Builder;
				public build(): androidx.webkit.SpeculativeLoadingParameters;
				public addAdditionalHeaders(additionalHeaders: java.util.Map<string,string>): androidx.webkit.SpeculativeLoadingParameters.Builder;
				public constructor();
				public setJavaScriptEnabled(javaScriptEnabled: boolean): androidx.webkit.SpeculativeLoadingParameters.Builder;
			}
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class URLUtilCompat extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.URLUtilCompat>;
...
declare module androidx {
	export module webkit {
		export class UserAgentMetadata extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.UserAgentMetadata>;
			public static BITNESS_DEFAULT: number;
			public getModel(): string;
			public getBitness(): number;
			public equals(obj: any): boolean;
			public equals(o: any): boolean;
			public getBrandVersionList(): java.util.List<androidx.webkit.UserAgentMetadata.BrandVersion>;
			public getPlatformVersion(): string;
			public getPlatform(): string;
			public isWow64(): boolean;
			public getFullVersion(): string;
			public getArchitecture(): string;
			public isMobile(): boolean;
			public hashCode(): number;
		}
		export module UserAgentMetadata {
			export class BrandVersion extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.UserAgentMetadata.BrandVersion>;
				public equals(obj: any): boolean;
				public hashCode(): number;
			...
			export module BrandVersion {
				export class Builder extends java.lang.Object {
					public static class: java.lang.Class<androidx.webkit.UserAgentMetadata.BrandVersion.Builder>;
					public constructor();
					public setFullVersion(fullVersion: string): androidx.webkit.UserAgentMetadata.BrandVersion.Builder;
					public setBrand(brand: string): androidx.webkit.UserAgentMetadata.BrandVersion.Builder;
					public setMajorVersion(majorVersion: string): androidx.webkit.UserAgentMetadata.BrandVersion.Builder;
					public constructor(brandVersion: androidx.webkit.UserAgentMetadata.BrandVersion);
					public build(): androidx.webkit.UserAgentMetadata.BrandVersion;
				}
			}
			export class Builder extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.UserAgentMetadata.Builder>;
				public constructor(uaMetadata: androidx.webkit.UserAgentMetadata);
				public setArchitecture(architecture: string): androidx.webkit.UserAgentMetadata.Builder;
				public setFullVersion(fullVersion: string): androidx.webkit.UserAgentMetadata.Builder;
				public setPlatform(platform: string): androidx.webkit.UserAgentMetadata.Builder;
				public setBitness(bitness: number): androidx.webkit.UserAgentMetadata.Builder;
				public setPlatformVersion(platformVersion: string): androidx.webkit.UserAgentMetadata.Builder;
				public setMobile(mobile: boolean): androidx.webkit.UserAgentMetadata.Builder;
				public setWow64(wow64: boolean): androidx.webkit.UserAgentMetadata.Builder;
				public setBrandVersionList(brandVersions: java.util.List<androidx.webkit.UserAgentMetadata.BrandVersion>): androidx.webkit.UserAgentMetadata.Builder;
				public build(): androidx.webkit.UserAgentMetadata;
				public setModel(model: string): androidx.webkit.UserAgentMetadata.Builder;
				public constructor();
			}
		}
	}
...
declare module androidx {
	export module webkit {
		export class WebSettingsCompat extends java.lang.Object {
			...
			public static ATTRIBUTION_BEHAVIOR_DISABLED: number;
			public static ATTRIBUTION_BEHAVIOR_APP_SOURCE_AND_WEB_TRIGGER: number;
			public static ATTRIBUTION_BEHAVIOR_WEB_SOURCE_AND_WEB_TRIGGER: number;
			public static ATTRIBUTION_BEHAVIOR_APP_SOURCE_AND_APP_TRIGGER: number;
			public static WEB_AUTHENTICATION_SUPPORT_NONE: number;
			public static WEB_AUTHENTICATION_SUPPORT_FOR_APP: number;
			public static WEB_AUTHENTICATION_SUPPORT_FOR_BROWSER: number;
			public static SPECULATIVE_LOADING_DISABLED: number;
			public static SPECULATIVE_LOADING_PRERENDER_ENABLED: number;
			public static getUserAgentMetadata(settings: android.webkit.WebSettings): androidx.webkit.UserAgentMetadata;
			public static getBackForwardCacheEnabled(settings: android.webkit.WebSettings): boolean;
			public static getSafeBrowsingEnabled(settings: android.webkit.WebSettings): boolean;
			public static setUserAgentMetadata(settings: android.webkit.WebSettings, metadata: androidx.webkit.UserAgentMetadata): void;
			public static getWebViewMediaIntegrityApiStatus(settings: android.webkit.WebSettings): androidx.webkit.WebViewMediaIntegrityApiStatusConfig;
			...
			public static getAttributionRegistrationBehavior(settings: android.webkit.WebSettings): number;
			public static setAttributionRegistrationBehavior(settings: android.webkit.WebSettings, behavior: number): void;
			/** @deprecated */
			...
			public static setWebViewMediaIntegrityApiStatus(settings: android.webkit.WebSettings, permissionConfig: androidx.webkit.WebViewMediaIntegrityApiStatusConfig): void;
			...
			public static setWebAuthenticationSupport(settings: android.webkit.WebSettings, support: number): void;
			public static setSpeculativeLoadingStatus(settings: android.webkit.WebSettings, speculativeLoadingStatus: number): void;
			/** @deprecated */
			public static getForceDarkStrategy(settings: android.webkit.WebSettings): number;
			public static getSpeculativeLoadingStatus(settings: android.webkit.WebSettings): number;
			/** @deprecated */
			...
			public static getWebAuthenticationSupport(settings: android.webkit.WebSettings): number;
			...
			public static setBackForwardCacheEnabled(settings: android.webkit.WebSettings, backForwardCacheEnabled: boolean): void;
			public static isAlgorithmicDarkeningAllowed(settings: android.webkit.WebSettings): boolean;
		}
		export module WebSettingsCompat {
			export class ExperimentalBackForwardCache extends java.lang.Object implements java.lang.annotation.Annotation {
				public static class: java.lang.Class<androidx.webkit.WebSettingsCompat.ExperimentalBackForwardCache>;
				/**
				 * Constructs a new instance of the androidx.webkit.WebSettingsCompat$ExperimentalBackForwardCache interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					equals(param0: any): boolean;
					hashCode(): number;
			...
			export class ExperimentalSpeculativeLoading extends java.lang.Object implements java.lang.annotation.Annotation {
				public static class: java.lang.Class<androidx.webkit.WebSettingsCompat.ExperimentalSpeculativeLoading>;
				/**
				 * Constructs a new instance of the androidx.webkit.WebSettingsCompat$ExperimentalSpeculativeLoading interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					equals(param0: any): boolean;
					hashCode(): number;
...
declare module androidx {
	export module webkit {
		export class WebStorageCompat extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.WebStorageCompat>;
			public static deleteBrowsingDataForSite(instance: android.webkit.WebStorage, site: string, executor: java.util.concurrent.Executor, doneCallback: java.lang.Runnable): string;
			public static deleteBrowsingData(instance: android.webkit.WebStorage, doneCallback: java.lang.Runnable): void;
			public static deleteBrowsingDataForSite(instance: android.webkit.WebStorage, site: string, doneCallback: java.lang.Runnable): string;
			public static deleteBrowsingData(instance: android.webkit.WebStorage, executor: java.util.concurrent.Executor, doneCallback: java.lang.Runnable): void;
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class WebViewCompat extends java.lang.Object {
			...
			public static setDefaultTrafficStatsTag(tag: number): void;
			...
			public static setProfile(webView: android.webkit.WebView, profileName: string): void;
			public static prerenderUrlAsync(webView: android.webkit.WebView, url: string, cancellationSignal: android.os.CancellationSignal, callbackExecutor: java.util.concurrent.Executor, params: androidx.webkit.SpeculativeLoadingParameters, callback: androidx.webkit.PrerenderOperationCallback): void;
			...
			public static prerenderUrlAsync(webView: android.webkit.WebView, url: string, cancellationSignal: android.os.CancellationSignal, callbackExecutor: java.util.concurrent.Executor, callback: androidx.webkit.PrerenderOperationCallback): void;
			...
			public static startUpWebView(config: androidx.webkit.WebViewStartUpConfig, callback: androidx.webkit.WebViewCompat.WebViewStartUpCallback): void;
			...
			public static isAudioMuted(webView: android.webkit.WebView): boolean;
			public static getWebViewClient(webview: android.webkit.WebView): android.webkit.WebViewClient;
			public static setAudioMuted(webView: android.webkit.WebView, mute: boolean): void;
			public static getProfile(webView: android.webkit.WebView): androidx.webkit.Profile;
		}
		export module WebViewCompat {
			export class ExperimentalAsyncStartUp extends java.lang.Object implements java.lang.annotation.Annotation {
				public static class: java.lang.Class<androidx.webkit.WebViewCompat.ExperimentalAsyncStartUp>;
				/**
				 * Constructs a new instance of the androidx.webkit.WebViewCompat$ExperimentalAsyncStartUp interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					equals(param0: any): boolean;
					hashCode(): number;
			...
			export class ExperimentalUrlPrerender extends java.lang.Object implements java.lang.annotation.Annotation {
				public static class: java.lang.Class<androidx.webkit.WebViewCompat.ExperimentalUrlPrerender>;
				/**
				 * Constructs a new instance of the androidx.webkit.WebViewCompat$ExperimentalUrlPrerender interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					equals(param0: any): boolean;
					hashCode(): number;
			...
			export class NullReturningWebViewStartUpResult extends java.lang.Object implements androidx.webkit.WebViewStartUpResult {
				public static class: java.lang.Class<androidx.webkit.WebViewCompat.NullReturningWebViewStartUpResult>;
				public getBlockingStartUpLocations(): java.util.List<androidx.webkit.BlockingStartUpLocation>;
				public getMaxTimePerTaskInUiThreadMillis(): java.lang.Long;
				public getTotalTimeInUiThreadMillis(): java.lang.Long;
			}
			...
			export class WebViewStartUpCallback extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.WebViewCompat.WebViewStartUpCallback>;
				/**
				 * Constructs a new instance of the androidx.webkit.WebViewCompat$WebViewStartUpCallback interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					onSuccess(param0: androidx.webkit.WebViewStartUpResult): void;
				});
				public constructor();
				public onSuccess(param0: androidx.webkit.WebViewStartUpResult): void;
			}
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class WebViewFeature extends java.lang.Object {
			...
			public static STARTUP_FEATURE_CONFIGURE_PARTITIONED_COOKIES: string;
			public static REQUESTED_WITH_HEADER_ALLOW_LIST: string;
			public static USER_AGENT_METADATA: string;
			public static MULTI_PROFILE: string;
			public static ATTRIBUTION_REGISTRATION_BEHAVIOR: string;
			public static WEBVIEW_MEDIA_INTEGRITY_API_STATUS: string;
			public static MUTE_AUDIO: string;
			public static WEB_AUTHENTICATION: string;
			public static SPECULATIVE_LOADING: string;
			public static BACK_FORWARD_CACHE: string;
			public static PROFILE_URL_PREFETCH: string;
			public static DEFAULT_TRAFFICSTATS_TAGGING: string;
			public static DELETE_BROWSING_DATA: string;
			public static PRERENDER_WITH_URL: string;
			public static SPECULATIVE_LOADING_CONFIG: string;
...
declare module androidx {
	export module webkit {
		export class WebViewMediaIntegrityApiStatusConfig extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.WebViewMediaIntegrityApiStatusConfig>;
			public static WEBVIEW_MEDIA_INTEGRITY_API_ENABLED: number;
			public static WEBVIEW_MEDIA_INTEGRITY_API_ENABLED_WITHOUT_APP_IDENTITY: number;
			public static WEBVIEW_MEDIA_INTEGRITY_API_DISABLED: number;
			public getDefaultStatus(): number;
			public getOverrideRules(): java.util.Map<string,java.lang.Integer>;
			public constructor(builder: androidx.webkit.WebViewMediaIntegrityApiStatusConfig.Builder);
		}
		export module WebViewMediaIntegrityApiStatusConfig {
			export class Builder extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.WebViewMediaIntegrityApiStatusConfig.Builder>;
				public addOverrideRule(originPattern: string, permission: number): androidx.webkit.WebViewMediaIntegrityApiStatusConfig.Builder;
				public constructor(defaultStatus: number);
				public build(): androidx.webkit.WebViewMediaIntegrityApiStatusConfig;
				public setOverrideRules(overrideRules: java.util.Map<string,java.lang.Integer>): androidx.webkit.WebViewMediaIntegrityApiStatusConfig.Builder;
			}
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class WebViewStartUpConfig extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.WebViewStartUpConfig>;
			public shouldRunUiThreadStartUpTasks(): boolean;
			public getBackgroundExecutor(): java.util.concurrent.Executor;
		}
		export module WebViewStartUpConfig {
			export class Builder extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.WebViewStartUpConfig.Builder>;
				public build(): androidx.webkit.WebViewStartUpConfig;
				public constructor(executor: java.util.concurrent.Executor);
				public setShouldRunUiThreadStartUpTasks(shouldRunUiThreadStartUpTasks: boolean): androidx.webkit.WebViewStartUpConfig.Builder;
			}
		}
	}
}
...
declare module androidx {
	export module webkit {
		export class WebViewStartUpResult extends java.lang.Object {
			public static class: java.lang.Class<androidx.webkit.WebViewStartUpResult>;
			/**
			 * Constructs a new instance of the androidx.webkit.WebViewStartUpResult interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
			 */
			public constructor(implementation: {
				getTotalTimeInUiThreadMillis(): java.lang.Long;
				getMaxTimePerTaskInUiThreadMillis(): java.lang.Long;
				getBlockingStartUpLocations(): java.util.List<androidx.webkit.BlockingStartUpLocation>;
			});
			public constructor();
			public getTotalTimeInUiThreadMillis(): java.lang.Long;
			public getMaxTimePerTaskInUiThreadMillis(): java.lang.Long;
	...
	export module webkit {
		export module internal {
			export class IncompatibleApkWebViewProviderFactory extends java.lang.Object implements androidx.webkit.internal.WebViewProviderFactory {
				...
				public getProfileStore(): org.chromium.support_lib_boundary.ProfileStoreBoundaryInterface;
				...
				public startUpWebView(param0: androidx.webkit.WebViewStartUpConfig, param1: androidx.webkit.WebViewCompat.WebViewStartUpCallback): void;
				...
				public startUpWebView(config: androidx.webkit.WebViewStartUpConfig, callback: androidx.webkit.WebViewCompat.WebViewStartUpCallback): void;
	...
	export module webkit {
		export module internal {
			export class JavaScriptReplyProxyImpl extends androidx.webkit.JavaScriptReplyProxy {
				...
				public postMessage(arrayBuffer: number[]): void;
				public postMessage(param0: string): void;
	...
	export module webkit {
		export module internal {
			export class MimeUtil extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.internal.MimeUtil>;
				public static getMimeFromFileName(fileName: string): string;
			}
		}
	}
}
...
declare module androidx {
	export module webkit {
		export module internal {
			export class NoVarySearchHeaderAdapter extends java.lang.Object implements org.chromium.support_lib_boundary.NoVarySearchDataBoundaryInterface {
				public static class: java.lang.Class<androidx.webkit.internal.NoVarySearchHeaderAdapter>;
				public constructor(impl: androidx.webkit.NoVarySearchHeader);
				public getIgnoreDifferencesInParameters(): boolean;
				public getVaryOnKeyOrder(): boolean;
				public getIgnoredQueryParameters(): java.util.List<string>;
				public getConsideredQueryParameters(): java.util.List<string>;
			}
		}
	}
}
...
declare module androidx {
	export module webkit {
		export module internal {
			export class PrefetchOperationCallbackAdapter extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.internal.PrefetchOperationCallbackAdapter>;
				public constructor();
				public static buildInvocationHandler(callback: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): java.lang.reflect.InvocationHandler;
			}
		}
	}
}
...
declare module androidx {
	export module webkit {
		export module internal {
			export class ProfileImpl extends java.lang.Object implements androidx.webkit.Profile {
				public static class: java.lang.Class<androidx.webkit.internal.ProfileImpl>;
				public getGeolocationPermissions(): android.webkit.GeolocationPermissions;
				public prefetchUrlAsync(url: string, cancellationSignal: android.os.CancellationSignal, callbackExecutor: java.util.concurrent.Executor, params: androidx.webkit.SpeculativeLoadingParameters, callback: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
				public getServiceWorkerController(): android.webkit.ServiceWorkerController;
				public getName(): string;
				public setSpeculativeLoadingConfig(speculativeLoadingConfig: androidx.webkit.SpeculativeLoadingConfig): void;
				public clearPrefetchAsync(url: string, callbackExecutor: java.util.concurrent.Executor, callback: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
				public prefetchUrlAsync(url: string, cancellationSignal: android.os.CancellationSignal, callbackExecutor: java.util.concurrent.Executor, callback: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
				public setSpeculativeLoadingConfig(param0: androidx.webkit.SpeculativeLoadingConfig): void;
				public prefetchUrlAsync(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
				public prefetchUrlAsync(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: androidx.webkit.SpeculativeLoadingParameters, param4: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
				public clearPrefetchAsync(param0: string, param1: java.util.concurrent.Executor, param2: androidx.webkit.OutcomeReceiverCompat<java.lang.Void,androidx.webkit.PrefetchException>): void;
...
declare module androidx {
	export module webkit {
		export module internal {
			export class ProfileStoreImpl extends java.lang.Object implements androidx.webkit.ProfileStore {
				public static class: java.lang.Class<androidx.webkit.internal.ProfileStoreImpl>;
				public getOrCreateProfile(name: string): androidx.webkit.Profile;
				public deleteProfile(param0: string): boolean;
				public static getInstance(): androidx.webkit.ProfileStore;
				public getAllProfileNames(): java.util.List<string>;
				public getProfile(name: string): androidx.webkit.Profile;
				public getProfile(param0: string): androidx.webkit.Profile;
...
declare module androidx {
	export module webkit {
		export module internal {
			export class ScriptHandlerImpl extends java.lang.Object implements androidx.webkit.ScriptHandler {
...
declare module androidx {
	export module webkit {
		export module internal {
			export class SpeculativeLoadingConfigAdapter extends java.lang.Object implements org.chromium.support_lib_boundary.SpeculativeLoadingConfigBoundaryInterface {
				public static class: java.lang.Class<androidx.webkit.internal.SpeculativeLoadingConfigAdapter>;
				public getMaxPrerenders(): number;
				public constructor(config: androidx.webkit.SpeculativeLoadingConfig);
				public getPrefetchTTLSeconds(): number;
				public getMaxPrefetches(): number;
			}
		}
...
declare module androidx {
	export module webkit {
		export module internal {
			export class SpeculativeLoadingParametersAdapter extends java.lang.Object implements org.chromium.support_lib_boundary.SpeculativeLoadingParametersBoundaryInterface {
				public static class: java.lang.Class<androidx.webkit.internal.SpeculativeLoadingParametersAdapter>;
				public getAdditionalHeaders(): java.util.Map<string,string>;
				public constructor(impl: androidx.webkit.SpeculativeLoadingParameters);
				public getNoVarySearchData(): java.lang.reflect.InvocationHandler;
				public isJavaScriptEnabled(): boolean;
			}
		}
	}
	...
	export module webkit {
		export module internal {
			...
			export module StartupApiFeature {
				export class NoFramework extends androidx.webkit.internal.StartupApiFeature {
					public static class: java.lang.Class<androidx.webkit.internal.StartupApiFeature.NoFramework>;
					public isSupportedByFramework(): boolean;
				}
	...
	export module webkit {
		export module internal {
			export class StartupFeatures extends java.lang.Object {
				...
				public static STARTUP_FEATURE_SET_DATA_DIRECTORY_SUFFIX: string;
				public static STARTUP_FEATURE_SET_DIRECTORY_BASE_PATH: string;
				public static STARTUP_FEATURE_CONFIGURE_PARTITIONED_COOKIES: string;
			}
		}
	}
...
declare module androidx {
	export module webkit {
		export module internal {
			export class UserAgentMetadataInternal extends java.lang.Object {
				public static class: java.lang.Class<androidx.webkit.internal.UserAgentMetadataInternal>;
				public constructor();
			}
		}
	}
	...
	export module webkit {
		export module internal {
			export class WebSettingsAdapter extends java.lang.Object {
				...
				public getWebAuthenticationSupport(): number;
				...
				public getUserAgentMetadata(): androidx.webkit.UserAgentMetadata;
				public getSafeBrowsingEnabled(): boolean;
				public getAttributionRegistrationBehavior(): number;
				public setWebAuthenticationSupport(support: number): void;
				public getForceDark(): number;
				public setEnterpriseAuthenticationAppLinkPolicyEnabled(enabled: boolean): void;
				public setBackForwardCacheEnabled(backForwardCacheEnabled: boolean): void;
				public getWebViewMediaIntegrityApiStatus(): androidx.webkit.WebViewMediaIntegrityApiStatusConfig;
				public getBackForwardCacheEnabled(): boolean;
				public getOffscreenPreRaster(): boolean;
				public setUserAgentMetadata(uaMetadata: androidx.webkit.UserAgentMetadata): void;
				public setForceDarkStrategy(forceDarkStrategy: number): void;
				public setAttributionRegistrationBehavior(behavior: number): void;
				public setSpeculativeLoadingStatus(speculativeLoadingStatus: number): void;
				public isAlgorithmicDarkeningAllowed(): boolean;
				public setWebViewMediaIntegrityApiStatus(permissionConfig: androidx.webkit.WebViewMediaIntegrityApiStatusConfig): void;
				public getSpeculativeLoadingStatus(): number;
...
declare module androidx {
	export module webkit {
		export module internal {
			export class WebSettingsNoOpAdapter extends androidx.webkit.internal.WebSettingsAdapter {
				public static class: java.lang.Class<androidx.webkit.internal.WebSettingsNoOpAdapter>;
				public setSafeBrowsingEnabled(enabled: boolean): void;
				public getWebAuthenticationSupport(): number;
				public getForceDarkStrategy(): number;
				public setRequestedWithHeaderOriginAllowList(allowList: java.util.Set<string>): void;
...
declare module androidx {
	export module webkit {
		export module internal {
			export class WebStorageAdapter extends java.lang.Object implements org.chromium.support_lib_boundary.WebStorageBoundaryInterface {
				public static class: java.lang.Class<androidx.webkit.internal.WebStorageAdapter>;
				public deleteBrowsingData(param0: java.util.concurrent.Executor, param1: java.lang.Runnable): void;
				public deleteBrowsingDataForSite(param0: string, param1: java.util.concurrent.Executor, param2: java.lang.Runnable): string;
				public deleteBrowsingDataForSite(domainOrUrl: string, callbackExecutor: java.util.concurrent.Executor, doneCallback: java.lang.Runnable): string;
				public deleteBrowsingData(callbackExecutor: java.util.concurrent.Executor, doneCallback: java.lang.Runnable): void;
				public constructor(impl: org.chromium.support_lib_boundary.WebStorageBoundaryInterface);
			}
		}
	}
}
	...
	export module webkit {
		export module internal {
			export class WebViewFeatureInternal extends java.lang.Object {
				...
				public static WEB_MESSAGE_ARRAY_BUFFER: androidx.webkit.internal.ApiFeature.NoFramework;
				...
				public static STARTUP_FEATURE_SET_DIRECTORY_BASE_PATH: androidx.webkit.internal.StartupApiFeature.NoFramework;
				public static STARTUP_FEATURE_CONFIGURE_PARTITIONED_COOKIES: androidx.webkit.internal.StartupApiFeature.NoFramework;
				...
				public static USER_AGENT_METADATA: androidx.webkit.internal.ApiFeature.NoFramework;
				public static MULTI_PROFILE: androidx.webkit.internal.ApiFeature.NoFramework;
				public static ATTRIBUTION_REGISTRATION_BEHAVIOR: androidx.webkit.internal.ApiFeature.NoFramework;
				public static WEBVIEW_MEDIA_INTEGRITY_API_STATUS: androidx.webkit.internal.ApiFeature.NoFramework;
				public static MUTE_AUDIO: androidx.webkit.internal.ApiFeature.NoFramework;
				public static WEB_AUTHENTICATION: androidx.webkit.internal.ApiFeature.NoFramework;
				public static SPECULATIVE_LOADING: androidx.webkit.internal.ApiFeature.NoFramework;
				public static BACK_FORWARD_CACHE: androidx.webkit.internal.ApiFeature.NoFramework;
				public static DELETE_BROWSING_DATA: androidx.webkit.internal.ApiFeature.NoFramework;
				public static PROFILE_URL_PREFETCH: androidx.webkit.internal.ApiFeature.NoFramework;
				public static ASYNC_WEBVIEW_STARTUP: androidx.webkit.internal.ApiFeature.NoFramework;
				public static DEFAULT_TRAFFICSTATS_TAGGING: androidx.webkit.internal.ApiFeature.NoFramework;
				public static PRERENDER_WITH_URL: androidx.webkit.internal.ApiFeature.NoFramework;
				public static SPECULATIVE_LOADING_CONFIG: androidx.webkit.internal.ApiFeature.NoFramework;
	...
	export module webkit {
		export module internal {
			export class WebViewProviderAdapter extends java.lang.Object {
				...
				public setProfileWithName(profileName: string): void;
				...
				public prerenderUrlAsync(url: string, cancellationSignal: android.os.CancellationSignal, callbackExecutor: java.util.concurrent.Executor, params: androidx.webkit.SpeculativeLoadingParameters, callback: androidx.webkit.PrerenderOperationCallback): void;
				public getWebViewClient(): android.webkit.WebViewClient;
				public getProfile(): androidx.webkit.Profile;
				...
				public prerenderUrlAsync(url: string, cancellationSignal: android.os.CancellationSignal, callbackExecutor: java.util.concurrent.Executor, callback: androidx.webkit.PrerenderOperationCallback): void;
		...
		export module internal {
			export class WebViewProviderFactory extends java.lang.Object {
				...
				public constructor(implementation: {
					...
					getProfileStore(): org.chromium.support_lib_boundary.ProfileStoreBoundaryInterface;
					startUpWebView(param0: androidx.webkit.WebViewStartUpConfig, param1: androidx.webkit.WebViewCompat.WebViewStartUpCallback): void;
				});
				public constructor();
				public getProxyController(): org.chromium.support_lib_boundary.ProxyControllerBoundaryInterface;
				public getProfileStore(): org.chromium.support_lib_boundary.ProfileStoreBoundaryInterface;
...
declare module androidx {
	export module webkit {
		export module internal {
			export class WebViewStartUpCallbackAdapter extends java.lang.Object implements org.chromium.support_lib_boundary.WebViewStartUpCallbackBoundaryInterface {
				public static class: java.lang.Class<androidx.webkit.internal.WebViewStartUpCallbackAdapter>;
				public constructor(webViewStartUpCallback: androidx.webkit.WebViewCompat.WebViewStartUpCallback);
				public onSuccess(resultInvocationHandler: java.lang.reflect.InvocationHandler): void;
				public onSuccess(param0: java.lang.reflect.InvocationHandler): void;
			}
			export module WebViewStartUpCallbackAdapter {
				export class BlockingStartUpLocationImpl extends java.lang.Object implements androidx.webkit.BlockingStartUpLocation {
					public static class: java.lang.Class<androidx.webkit.internal.WebViewStartUpCallbackAdapter.BlockingStartUpLocationImpl>;
					public getStackInformation(): string;
				}
			}
		}
...
declare module androidx {
	export module webkit {
		export module internal {
			export class WebViewStartUpConfigAdapter extends java.lang.Object implements org.chromium.support_lib_boundary.WebViewStartUpConfigBoundaryInterface {
				public static class: java.lang.Class<androidx.webkit.internal.WebViewStartUpConfigAdapter>;
				public shouldRunUiThreadStartUpTasks(): boolean;
				public getBackgroundExecutor(): java.util.concurrent.Executor;
				public constructor(webViewStartUpConfig: androidx.webkit.WebViewStartUpConfig);
			}
		}
	}
}
	...
	export module webkit {
		export module internal {
			export class WebkitToCompatConverter extends java.lang.Object {
				...
				public convertWebStorage(webStorage: android.webkit.WebStorage): androidx.webkit.internal.WebStorageAdapter;
		...
		export module support_lib_boundary {
			export class JsReplyProxyBoundaryInterface extends java.lang.Object implements org.chromium.support_lib_boundary.IsomorphicObjectBoundaryInterface {
				...
				public constructor(implementation: {
					...
					postMessageWithPayload(param0: java.lang.reflect.InvocationHandler): void;
					getOrCreatePeer(param0: java.util.concurrent.Callable<any>): any;
				});
				public constructor();
				public postMessageWithPayload(param0: java.lang.reflect.InvocationHandler): void;
				public postMessage(param0: string): void;
				public getOrCreatePeer(param0: java.util.concurrent.Callable<any>): any;
			}
		}
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class NoVarySearchDataBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.NoVarySearchDataBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.NoVarySearchDataBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					getVaryOnKeyOrder(): boolean;
					getIgnoreDifferencesInParameters(): boolean;
					getIgnoredQueryParameters(): java.util.List<string>;
					getConsideredQueryParameters(): java.util.List<string>;
				});
				public constructor();
				public getIgnoreDifferencesInParameters(): boolean;
				public getVaryOnKeyOrder(): boolean;
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class PrefetchExceptionBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.PrefetchExceptionBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.PrefetchExceptionBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					getMessage(): string;
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class PrefetchNetworkExceptionBoundaryInterface extends java.lang.Object implements org.chromium.support_lib_boundary.PrefetchExceptionBoundaryInterface {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.PrefetchNetworkExceptionBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.PrefetchNetworkExceptionBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
				...
				public constructor();
				public getHttpResponseStatusCode(): number;
				public getMessage(): string;
				public getCause(): java.lang.Throwable;
			}
		}
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class PrefetchOperationCallbackBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.PrefetchOperationCallbackBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.PrefetchOperationCallbackBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					onSuccess(): void;
					onFailure(param0: java.lang.reflect.InvocationHandler): void;
				});
				public constructor();
				public onFailure(param0: java.lang.reflect.InvocationHandler): void;
	...
	export module chromium {
		export module support_lib_boundary {
			export class ProcessGlobalConfigConstants extends java.lang.Object {
				...
				public static DATA_DIRECTORY_BASE_PATH: string;
				public static CACHE_DIRECTORY_BASE_PATH: string;
				public static CONFIGURE_PARTITIONED_COOKIES: string;
			}
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class ProfileBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.ProfileBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.ProfileBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					getName(): string;
					getCookieManager(): android.webkit.CookieManager;
					...
					getGeoLocationPermissions(): android.webkit.GeolocationPermissions;
					getServiceWorkerController(): android.webkit.ServiceWorkerController;
					prefetchUrl(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: java.lang.reflect.InvocationHandler): void;
					prefetchUrl(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: java.lang.reflect.InvocationHandler, param4: java.lang.reflect.InvocationHandler): void;
					clearPrefetch(param0: string, param1: java.util.concurrent.Executor, param2: java.lang.reflect.InvocationHandler): void;
					setSpeculativeLoadingConfig(param0: java.lang.reflect.InvocationHandler): void;
				});
				public constructor();
				public setSpeculativeLoadingConfig(param0: java.lang.reflect.InvocationHandler): void;
				public prefetchUrl(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: java.lang.reflect.InvocationHandler): void;
				public prefetchUrl(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: java.lang.reflect.InvocationHandler, param4: java.lang.reflect.InvocationHandler): void;
				public clearPrefetch(param0: string, param1: java.util.concurrent.Executor, param2: java.lang.reflect.InvocationHandler): void;
				public getServiceWorkerController(): android.webkit.ServiceWorkerController;
				public getName(): string;
				public getGeoLocationPermissions(): android.webkit.GeolocationPermissions;
				public getCookieManager(): android.webkit.CookieManager;
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class ProfileStoreBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.ProfileStoreBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.ProfileStoreBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					getOrCreateProfile(param0: string): java.lang.reflect.InvocationHandler;
					getProfile(param0: string): java.lang.reflect.InvocationHandler;
					getAllProfileNames(): java.util.List<string>;
					deleteProfile(param0: string): boolean;
				});
				public constructor();
				public deleteProfile(param0: string): boolean;
				public getAllProfileNames(): java.util.List<string>;
				public getOrCreateProfile(param0: string): java.lang.reflect.InvocationHandler;
				public getProfile(param0: string): java.lang.reflect.InvocationHandler;
			}
		}
	}
}
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class SpeculativeLoadingConfigBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.SpeculativeLoadingConfigBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.SpeculativeLoadingConfigBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					getMaxPrefetches(): number;
					getPrefetchTTLSeconds(): number;
					getMaxPrerenders(): number;
				});
				public constructor();
				public getMaxPrerenders(): number;
				public getPrefetchTTLSeconds(): number;
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class SpeculativeLoadingParametersBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.SpeculativeLoadingParametersBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.SpeculativeLoadingParametersBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					getAdditionalHeaders(): java.util.Map<string,string>;
					getNoVarySearchData(): java.lang.reflect.InvocationHandler;
		...
		export module support_lib_boundary {
			export class StaticsBoundaryInterface extends java.lang.Object {
				...
				public constructor(implementation: {
					...
					setDefaultTrafficStatsTag(param0: number): void;
					setDefaultTrafficStatsUid(param0: number): void;
				});
				public constructor();
				public getSafeBrowsingPrivacyPolicyUrl(): android.net.Uri;
				public setDefaultTrafficStatsUid(param0: number): void;
				public setDefaultTrafficStatsTag(param0: number): void;
		...
		export module support_lib_boundary {
			export class WebSettingsBoundaryInterface extends java.lang.Object {
				...
				public constructor(implementation: {
					...
					setUserAgentMetadataFromMap(param0: java.util.Map<string,any>): void;
					getUserAgentMetadataMap(): java.util.Map<string,any>;
					setAttributionBehavior(param0: number): void;
					getAttributionBehavior(): number;
					setWebViewMediaIntegrityApiStatus(param0: number, param1: java.util.Map<string,java.lang.Integer>): void;
					getWebViewMediaIntegrityApiDefaultStatus(): number;
					getWebViewMediaIntegrityApiOverrideRules(): java.util.Map<string,java.lang.Integer>;
					setSpeculativeLoadingStatus(param0: number): void;
					getSpeculativeLoadingStatus(): number;
					setBackForwardCacheEnabled(param0: boolean): void;
					getBackForwardCacheEnabled(): boolean;
				});
				public constructor();
				public setAttributionBehavior(param0: number): void;
				...
				public getWebViewMediaIntegrityApiOverrideRules(): java.util.Map<string,java.lang.Integer>;
				public setAlgorithmicDarkeningAllowed(param0: boolean): void;
				public setDisabledActionModeMenuItems(param0: number): void;
				public getUserAgentMetadataMap(): java.util.Map<string,any>;
				public getDisabledActionModeMenuItems(): number;
				public getRequestedWithHeaderOriginAllowList(): java.util.Set<string>;
				public getAttributionBehavior(): number;
				public setUserAgentMetadataFromMap(param0: java.util.Map<string,any>): void;
				public getForceDarkBehavior(): number;
				public getSafeBrowsingEnabled(): boolean;
				public setBackForwardCacheEnabled(param0: boolean): void;
				public getForceDark(): number;
				public setWebViewMediaIntegrityApiStatus(param0: number, param1: java.util.Map<string,java.lang.Integer>): void;
				public getWebViewMediaIntegrityApiDefaultStatus(): number;
				public getBackForwardCacheEnabled(): boolean;
				public getOffscreenPreRaster(): boolean;
				...
				public setSpeculativeLoadingStatus(param0: number): void;
				public isAlgorithmicDarkeningAllowed(): boolean;
			...
			export module WebSettingsBoundaryInterface {
				export class AttributionBehavior extends java.lang.Object implements java.lang.annotation.Annotation {
					public static class: java.lang.Class<org.chromium.support_lib_boundary.WebSettingsBoundaryInterface.AttributionBehavior>;
					/**
					 * Constructs a new instance of the org.chromium.support_lib_boundary.WebSettingsBoundaryInterface$AttributionBehavior interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
					 */
					public constructor(implementation: {
						equals(param0: any): boolean;
						hashCode(): number;
					...
					public constructor();
					public static WEB_SOURCE_AND_WEB_TRIGGER: number;
					public static DISABLED: number;
					public static APP_SOURCE_AND_WEB_TRIGGER: number;
					public static APP_SOURCE_AND_APP_TRIGGER: number;
					public equals(param0: any): boolean;
					public equals(obj: any): boolean;
					public toString(): string;
					public annotationType(): java.lang.Class<any>;
				...
				export class SpeculativeLoadingStatus extends java.lang.Object implements java.lang.annotation.Annotation {
					public static class: java.lang.Class<org.chromium.support_lib_boundary.WebSettingsBoundaryInterface.SpeculativeLoadingStatus>;
					/**
					 * Constructs a new instance of the org.chromium.support_lib_boundary.WebSettingsBoundaryInterface$SpeculativeLoadingStatus interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
					 */
					public constructor(implementation: {
						equals(param0: any): boolean;
						hashCode(): number;
					...
					public constructor();
					public static DISABLED: number;
					public static PRERENDER_ENABLED: number;
					public equals(param0: any): boolean;
					public equals(obj: any): boolean;
					public toString(): string;
					public annotationType(): java.lang.Class<any>;
				...
				export class WebViewMediaIntegrityApiStatus extends java.lang.Object implements java.lang.annotation.Annotation {
					public static class: java.lang.Class<org.chromium.support_lib_boundary.WebSettingsBoundaryInterface.WebViewMediaIntegrityApiStatus>;
					/**
					 * Constructs a new instance of the org.chromium.support_lib_boundary.WebSettingsBoundaryInterface$WebViewMediaIntegrityApiStatus interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
					 */
					public constructor(implementation: {
						equals(param0: any): boolean;
						hashCode(): number;
					...
					public static ENABLED_WITHOUT_APP_IDENTITY: number;
					public static DISABLED: number;
					public equals(param0: any): boolean;
					public equals(obj: any): boolean;
					public toString(): string;
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class WebStorageBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.WebStorageBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.WebStorageBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					deleteBrowsingData(param0: java.util.concurrent.Executor, param1: java.lang.Runnable): void;
					deleteBrowsingDataForSite(param0: string, param1: java.util.concurrent.Executor, param2: java.lang.Runnable): string;
				});
				public constructor();
				public deleteBrowsingData(param0: java.util.concurrent.Executor, param1: java.lang.Runnable): void;
				public deleteBrowsingDataForSite(param0: string, param1: java.util.concurrent.Executor, param2: java.lang.Runnable): string;
		...
		export module support_lib_boundary {
			export class WebViewProviderBoundaryInterface extends java.lang.Object {
				...
				public constructor(implementation: {
					...
					setProfile(param0: string): void;
					setAudioMuted(param0: boolean): void;
					isAudioMuted(): boolean;
					getProfile(): java.lang.reflect.InvocationHandler;
					prerenderUrl(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: android.webkit.ValueCallback<java.lang.Void>, param4: android.webkit.ValueCallback<java.lang.Throwable>): void;
					prerenderUrl(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: java.lang.reflect.InvocationHandler, param4: android.webkit.ValueCallback<java.lang.Void>, param5: android.webkit.ValueCallback<java.lang.Throwable>): void;
				});
				public constructor();
				...
				public setAudioMuted(param0: boolean): void;
				public getWebViewClient(): android.webkit.WebViewClient;
				public prerenderUrl(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: android.webkit.ValueCallback<java.lang.Void>, param4: android.webkit.ValueCallback<java.lang.Throwable>): void;
				public setProfile(param0: string): void;
				public createWebMessageChannel(): java.lang.reflect.InvocationHandler[];
				public prerenderUrl(param0: string, param1: android.os.CancellationSignal, param2: java.util.concurrent.Executor, param3: java.lang.reflect.InvocationHandler, param4: android.webkit.ValueCallback<java.lang.Void>, param5: android.webkit.ValueCallback<java.lang.Throwable>): void;
				public getWebChromeClient(): android.webkit.WebChromeClient;
				...
				public isAudioMuted(): boolean;
				public getProfile(): java.lang.reflect.InvocationHandler;
		...
		export module support_lib_boundary {
			export class WebViewProviderFactoryBoundaryInterface extends java.lang.Object {
				...
				public constructor(implementation: {
					...
					getProfileStore(): java.lang.reflect.InvocationHandler;
					startUpWebView(param0: java.lang.reflect.InvocationHandler, param1: java.lang.reflect.InvocationHandler): void;
				});
				public constructor();
				...
				public startUpWebView(param0: java.lang.reflect.InvocationHandler, param1: java.lang.reflect.InvocationHandler): void;
				public getProfileStore(): java.lang.reflect.InvocationHandler;
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class WebViewStartUpCallbackBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.WebViewStartUpCallbackBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.WebViewStartUpCallbackBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					onSuccess(param0: java.lang.reflect.InvocationHandler): void;
				});
				public constructor();
				public onSuccess(param0: java.lang.reflect.InvocationHandler): void;
			}
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class WebViewStartUpConfigBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.WebViewStartUpConfigBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.WebViewStartUpConfigBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class WebViewStartUpResultBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.WebViewStartUpResultBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.WebViewStartUpResultBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					getTotalTimeInUiThreadMillis(): java.lang.Long;
					getMaxTimePerTaskInUiThreadMillis(): java.lang.Long;
					getBlockingStartUpLocations(): java.util.List<java.lang.Throwable>;
				});
				public constructor();
				public getBlockingStartUpLocations(): java.util.List<java.lang.Throwable>;
				public getMaxTimePerTaskInUiThreadMillis(): java.lang.Long;
				public getTotalTimeInUiThreadMillis(): java.lang.Long;
			}
		}
		...
		export module support_lib_boundary {
			export class WebkitToCompatConverterBoundaryInterface extends java.lang.Object {
				...
				public constructor(implementation: {
					...
					convertWebStorage(param0: any): java.lang.reflect.InvocationHandler;
				});
				public constructor();
				...
				public convertWebStorage(param0: any): java.lang.reflect.InvocationHandler;
		...
		export module support_lib_boundary {
			export module util {
				export class Contract extends java.lang.Object implements java.lang.annotation.Annotation {
					public static class: java.lang.Class<org.chromium.support_lib_boundary.util.Contract>;
					/**
					 * Constructs a new instance of the org.chromium.support_lib_boundary.util.Contract interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
					 */
					public constructor(implementation: {
						value(): string;
						equals(param0: any): boolean;
		...
		export module support_lib_boundary {
			export module util {
				export class Features extends java.lang.Object {
					...
					public static MULTI_PROFILE: string;
					public static RESTRICT_SENSITIVE_WEB_CONTENT: string;
					public static USER_AGENT_METADATA: string;
					public static ATTRIBUTION_BEHAVIOR: string;
					public static WEBVIEW_MEDIA_INTEGRITY_API_STATUS: string;
					public static MUTE_AUDIO: string;
					public static SPECULATIVE_LOADING: string;
					public static BACK_FORWARD_CACHE: string;
					public static PREFETCH_WITH_URL: string;
					public static DEFAULT_TRAFFICSTATS_TAGGING: string;
					public static ASYNC_WEBVIEW_STARTUP: string;
					public static PRERENDER_WITH_URL: string;
					public static WEB_STORAGE_DELETE_BROWSING_DATA: string;
					public static SPECULATIVE_LOADING_CONFIG: string;
				}
			}
		}
...
//androidx.webkit.OutcomeReceiverCompat:2
