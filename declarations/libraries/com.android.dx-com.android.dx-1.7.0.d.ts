	...
	export module android {
		export module dex {
			export class Dex extends java.lang.Object {
				...
				public findTypeIndex(descriptor: string): number;
				...
				public nameIndexFromMethodIndex(methodIndex: number): number;
				public typeIndexFromFieldIndex(fieldIndex: number): number;
				public findFieldIndex(fieldId: com.android.dex.FieldId): number;
				public open(position: number): com.android.dex.Dex.Section;
				public findClassDefIndexFromTypeIndex(typeIndex: number): number;
				public typeNames(): java.util.List<string>;
				public readCode(method: com.android.dex.ClassData.Method): com.android.dex.Code;
				public nameIndexFromFieldIndex(fieldIndex: number): number;
				public getTableOfContents(): com.android.dex.TableOfContents;
				public returnTypeIndexFromMethodIndex(methodIndex: number): number;
				public constructor(data: number[]);
				public interfaceTypeIndicesFromClassDefIndex(classDefIndex: number): number[];
				public parameterTypeIndicesFromMethodIndex(methodIndex: number): number[];
				...
				public typeIndexFromClassDefIndex(classDefIndex: number): number;
				...
				public findStringIndex(s: string): number;
				public declaringClassIndexFromMethodIndex(methodIndex: number): number;
				...
				public findMethodIndex(methodId: com.android.dex.MethodId): number;
				public static create(data: java.nio.ByteBuffer): com.android.dex.Dex;
			}
			export module Dex {
	...
	export module android {
		export module dex {
			export class TableOfContents extends java.lang.Object {
				...
				public writeHeader(out: com.android.dex.Dex.Section): void;
				public constructor();
			}
			...
			export module cf {
				export module code {
					export class ConcreteMethod extends java.lang.Object implements com.android.dx.cf.iface.Method {
						...
						public constructor(method: com.android.dx.cf.iface.Method, accessFlags: number, sourceFile: com.android.dx.rop.cst.CstString, keepLines: boolean, keepLocals: boolean);
			...
			export module cf {
				export module code {
					export class Ropper extends java.lang.Object {
						...
						public static convert(method: com.android.dx.cf.code.ConcreteMethod, advice: com.android.dx.rop.code.TranslationAdvice, methods: com.android.dx.cf.iface.MethodList): com.android.dx.rop.code.RopMethod;
					}
			...
			export module cf {
				export module code {
					export class Simulator extends java.lang.Object {
						...
						public constructor(machine: com.android.dx.cf.code.Machine, method: com.android.dx.cf.code.ConcreteMethod);
					}
	...
	export module android {
		export module dx {
			export module command {
				export class DxConsole extends java.lang.Object {
					public static class: java.lang.Class<com.android.dx.command.DxConsole>;
					public static out: java.io.PrintStream;
					public static err: java.io.PrintStream;
					public static noop: java.io.PrintStream;
					public constructor();
				}
			}
		}
			...
			export module command {
				export module dexer {
					export class Main extends java.lang.Object {
						...
						public static getTooManyIdsErrorMessage(): string;
						public static main(argArray: string[]): void;
			...
			export module dex {
				export module cf {
					export class CfTranslator extends java.lang.Object {
						...
						public static translate(cf: com.android.dx.cf.direct.DirectClassFile, bytes: number[], cfOptions: com.android.dx.dex.cf.CfOptions, dexOptions: com.android.dx.dex.DexOptions, dexFile: com.android.dx.dex.file.DexFile): com.android.dx.dex.file.ClassDefItem;
					}
				}
			}
		}
			...
			export module dex {
				export module cf {
					export class CodeStatistics extends java.lang.Object {
						...
						public static runningDeltaRegisters: number;
						public static runningDeltaInsns: number;
						public static runningTotalInsns: number;
						public static dexRunningDeltaRegisters: number;
						public static dexRunningDeltaInsns: number;
						public static dexRunningTotalInsns: number;
						public static runningOriginalBytes: number;
						public static updateOriginalByteCount(count: number): void;
						public static dumpStatistics(out: java.io.PrintStream): void;
						public static updateDexStatistics(nonOptCode: com.android.dx.dex.code.DalvCode, code: com.android.dx.dex.code.DalvCode): void;
						public static updateRopStatistics(nonOptRmeth: com.android.dx.rop.code.RopMethod, rmeth: com.android.dx.rop.code.RopMethod): void;
					}
				}
			}
		}
			...
			export module dex {
				export module cf {
					export class OptimizerOptions extends java.lang.Object {
						...
						public static loadOptimizeLists(optimizeListFile: string, dontOptimizeListFile: string): void;
						public static compareOptimizerStep(nonOptRmeth: com.android.dx.rop.code.RopMethod, paramSize: number, isStatic: boolean, args: com.android.dx.dex.cf.CfOptions, advice: com.android.dx.rop.code.TranslationAdvice, rmeth: com.android.dx.rop.code.RopMethod): void;
						public static shouldOptimize(canonicalMethodName: string): boolean;
					}
				}
			}
		}
			...
			export module dex {
				export module code {
					export abstract class InsnFormat extends java.lang.Object {
						...
						public static cstComment(insn: com.android.dx.dex.code.DalvInsn): string;
						...
						public static cstString(insn: com.android.dx.dex.code.DalvInsn): string;
		...
		export module dx {
			export module merge {
				export class DexMerger extends java.lang.Object {
					...
					public static main(args: string[]): void;
					public constructor(dexes: com.android.dex.Dex[], collisionPolicy: com.android.dx.merge.CollisionPolicy);
				}
				export module DexMerger {
					export abstract class IdMerger<T>  extends java.lang.Object {
						...
						public constructor(param0: com.android.dx.merge.DexMerger, out: com.android.dex.Dex.Section);
		...
		export module dx {
			export module merge {
				export class IndexMap extends java.lang.Object {
					...
					public putStaticValuesOffset(oldOffset: number, newOffset: number): void;
					...
					public adjustStaticValues(staticValuesOffset: number): number;
			...
			export module util {
				...
				export module ByteArray {
					...
					export class MyInputStream extends java.io.InputStream {
						...
						public read(): number;
						public constructor();
						public constructor(param0: com.android.dx.util.ByteArray);
