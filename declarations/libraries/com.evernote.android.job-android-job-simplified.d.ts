				...
				export module util {
					export module support {
						export class XmlUtils extends java.lang.Object {
							...
							public static readIntAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string, defaultValue: number): number;
							public static readStringAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string): string;
							...
							public static readListXml(_in_: java.io.InputStream): java.util.ArrayList<any>;
							...
							public static readBooleanAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string, defaultValue: boolean): boolean;
							...
							public static readIntAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string): number;
							public static readLongAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string, defaultValue: number): number;
							...
							public static readLongAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string): number;
							public static readBitmapAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string): android.graphics.Bitmap;
							public static readByteArrayAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string): number[];
							...
							public static readMapXml(_in_: java.io.InputStream): java.util.HashMap<string,any>;
							...
							public static readSetXml(_in_: java.io.InputStream): java.util.HashSet<any>;
							...
							public static readFloatAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string): number;
							public static readBooleanAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string): boolean;
							public static readUriAttribute(_in_: org.xmlpull.v1.XmlPullParser, name: string): android.net.Uri;
