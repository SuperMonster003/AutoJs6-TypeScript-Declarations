...
declare module com {
	export module afollestad {
		export module materialdialogs {
			export module color {
				export class ColorChooserDialog implements android.view.View.OnClickListener, android.view.View.OnLongClickListener {
					...
					public show(fragmentManager: android.support.v4.app.FragmentManager): com.afollestad.materialdialogs.color.ColorChooserDialog;
					public show(fragmentActivity: android.support.v4.app.FragmentActivity): com.afollestad.materialdialogs.color.ColorChooserDialog;
					...
					public static findVisible(fragmentManager: android.support.v4.app.FragmentManager, tag: string): com.afollestad.materialdialogs.color.ColorChooserDialog;
					public constructor();
	...
	export module afollestad {
		export module materialdialogs {
			export module folderselector {
				export class FileChooserDialog implements com.afollestad.materialdialogs.MaterialDialog.ListCallback {
					public static class: java.lang.Class<com.afollestad.materialdialogs.folderselector.FileChooserDialog>;
					public show(fragmentManager: android.support.v4.app.FragmentManager): void;
					...
					public onAttach(context: android.content.Context): void;
					public onCreateDialog(savedInstanceState: android.os.Bundle): android.app.Dialog;
					public show(fragmentActivity: android.support.v4.app.FragmentActivity): void;
				...
				export module FileChooserDialog {
					export class Builder extends java.lang.Object implements java.io.Serializable {
						...
						public show(fragmentManager: android.support.v4.app.FragmentManager): com.afollestad.materialdialogs.folderselector.FileChooserDialog;
						public constructor(context: android.content.Context);
						...
						public show(fragmentActivity: android.support.v4.app.FragmentActivity): com.afollestad.materialdialogs.folderselector.FileChooserDialog;
					}
...
declare module com {
	export module afollestad {
		export module materialdialogs {
			export module folderselector {
				export class FolderChooserDialog implements com.afollestad.materialdialogs.MaterialDialog.ListCallback {
				...
				export module FolderChooserDialog {
					export class Builder extends java.lang.Object implements java.io.Serializable {
						...
						public show(fragmentManager: android.support.v4.app.FragmentManager): com.afollestad.materialdialogs.folderselector.FolderChooserDialog;
						...
						public show(fragmentActivity: android.support.v4.app.FragmentActivity): com.afollestad.materialdialogs.folderselector.FolderChooserDialog;
					}
	...
	export module afollestad {
		export module materialdialogs {
			export module simplelist {
				export class MaterialSimpleListAdapter extends android.support.v7.widget.RecyclerView.Adapter<com.afollestad.materialdialogs.simplelist.MaterialSimpleListAdapter.SimpleListVH> implements com.afollestad.materialdialogs.internal.MDAdapter  {
				...
				export module MaterialSimpleListAdapter {
					...
					export class SimpleListVH implements android.view.View.OnClickListener {
