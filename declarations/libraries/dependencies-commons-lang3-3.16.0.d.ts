...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export class AppendableJoiner<T>  extends java.lang.Object {
					public static class: java.lang.Class<org.apache.commons.lang3.AppendableJoiner<any>>;
					public join(stringBuilder: java.lang.StringBuilder, ...elements: T[]): java.lang.StringBuilder;
					public static builder(): org.apache.commons.lang3.AppendableJoiner.Builder<any>;
					public join(stringBuilder: java.lang.StringBuilder, elements: java.lang.Iterable<T>): java.lang.StringBuilder;
					public joinA(appendable: java.lang.Appendable, elements: java.lang.Iterable<any>): java.lang.Appendable;
					public joinA(appendable: java.lang.Appendable, ...elements: any[]): java.lang.Appendable;
				}
				export module AppendableJoiner {
					export class Builder<T>  extends java.lang.Object /* any*/ {
						public static class: java.lang.Class<org.apache.commons.lang3.AppendableJoiner.Builder<any>>;
						public get(): org.apache.commons.lang3.AppendableJoiner<any>;
						public setElementAppender(appender: org.apache.commons.lang3.function.FailableBiConsumer<java.lang.Appendable,any,java.io.IOException>): org.apache.commons.lang3.AppendableJoiner.Builder<any>;
						public setSuffix(suffix: string): org.apache.commons.lang3.AppendableJoiner.Builder<any>;
						public setPrefix(prefix: string): org.apache.commons.lang3.AppendableJoiner.Builder<any>;
						public setDelimiter(delimiter: string): org.apache.commons.lang3.AppendableJoiner.Builder<any>;
					}
				}
			}
		}
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export class ArrayFill extends java.lang.Object {
					public static class: java.lang.Class<org.apache.commons.lang3.ArrayFill>;
					public static fill(a: number[], val: number): number[];
					public static fill(a: string[], val: string): string[];
					public static fill(a: any[], val: any): any[];
				}
			}
		}
	}
		...
		export module commons {
			export module lang3 {
				export class ArrayUtils extends java.lang.Object {
					...
					public static arraycopy(source: any, sourcePos: number, destPos: number, length: number, allocator: any /* any*/): any;
					...
					public static nullTo(array: any[], defaultArray: any[]): any[];
					...
					public static arraycopy(source: any, sourcePos: number, dest: any, destPos: number, length: number): any;
					/** @deprecated */
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export class CachedRandomBits extends java.lang.Object {
					public static class: java.lang.Class<org.apache.commons.lang3.CachedRandomBits>;
					public nextBits(bits: number): number;
				}
			}
		}
	}
		...
		export module commons {
			export module lang3 {
				export class CharUtils extends java.lang.Object {
					...
					/** @deprecated */
					public static toCharacterObject(c: string): java.lang.Character;
		...
		export module commons {
			export module lang3 {
				export class JavaVersion {
					...
					public static JAVA_22: org.apache.commons.lang3.JavaVersion;
		...
		export module commons {
			export module lang3 {
				export class LocaleUtils extends java.lang.Object {
					...
					public static isLanguageUndetermined(locale: java.util.Locale): boolean;
		...
		export module commons {
			export module lang3 {
				export class ObjectUtils extends java.lang.Object {
					...
					public static toString(obj: any /* any*/, supplier: any /* any*/): string;
		...
		export module commons {
			export module lang3 {
				export class RandomStringUtils extends java.lang.Object {
					...
					public next(count: number, start: number, end: number, letters: boolean, numbers: boolean): string;
					public static randomNumeric(minLengthInclusive: number, maxLengthExclusive: number): string;
					public next(count: number, start: number, end: number, letters: boolean, numbers: boolean, ...chars: string[]): string;
					public static randomGraph(minLengthInclusive: number, maxLengthExclusive: number): string;
					public next(count: number, ...chars: string[]): string;
					...
					public nextGraph(minLengthInclusive: number, maxLengthExclusive: number): string;
					...
					/** @deprecated */
					public constructor();
					public nextAlphanumeric(minLengthInclusive: number, maxLengthExclusive: number): string;
					public static randomPrint(count: number): string;
					public next(count: number): string;
					public nextNumeric(count: number): string;
					public next(count: number, chars: string): string;
					public nextPrint(minLengthInclusive: number, maxLengthExclusive: number): string;
					public static randomGraph(count: number): string;
					public next(count: number, letters: boolean, numbers: boolean): string;
					public static randomAlphabetic(count: number): string;
					public nextPrint(count: number): string;
					public static insecure(): org.apache.commons.lang3.RandomStringUtils;
					public nextAlphabetic(count: number): string;
					public static random(count: number, start: number, end: number, letters: boolean, numbers: boolean, ...chars: string[]): string;
					public nextAlphanumeric(count: number): string;
					public nextNumeric(minLengthInclusive: number, maxLengthExclusive: number): string;
					public nextAscii(count: number): string;
					public nextGraph(count: number): string;
					public static random(count: number, chars: string): string;
					public static secure(): org.apache.commons.lang3.RandomStringUtils;
					...
					public nextAscii(minLengthInclusive: number, maxLengthExclusive: number): string;
					public nextAlphabetic(minLengthInclusive: number, maxLengthExclusive: number): string;
				}
			}
		}
	}
		...
		export module commons {
			export module lang3 {
				export class RandomUtils extends java.lang.Object {
					...
					public randomDouble(startInclusive: number, param1: number): number;
					public randomLong(startInclusive: number, param1: number): number;
					public static nextFloat(): number;
					public static nextInt(): number;
					public randomFloat(startInclusive: number, endExclusive: number): number;
					public randomInt(startInclusive: number, endExclusive: number): number;
					...
					public randomBytes(count: number): number[];
					...
					public static secure(): org.apache.commons.lang3.RandomUtils;
				}
			}
		}
	}
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export class RuntimeEnvironment extends java.lang.Object {
					public static class: java.lang.Class<org.apache.commons.lang3.RuntimeEnvironment>;
					public static inContainer(): java.lang.Boolean;
					/** @deprecated */
					public constructor();
				}
			}
		...
		export module commons {
			export module lang3 {
				export class SystemProperties extends java.lang.Object {
					...
					public static APPLE_AWT_ENABLE_TEMPLATE_IMAGES: string;
					public static AWT_TOOLKIT: string;
					public static COM_SUN_JNDI_LDAP_OBJECT_TRUST_SERIAL_DATA: string;
					public static COM_SUN_NET_HTTP_SERVER_HTTP_SERVER_PROVIDER: string;
					public static FILE_ENCODING: string;
					public static FILE_SEPARATOR: string;
					public static FTP_NON_PROXY_HOST: string;
					public static FTP_PROXY_HOST: string;
					public static FTP_PROXY_PORT: string;
					public static HTTP_AGENT: string;
					public static HTTP_AUTH_DIGEST_CNONCE_REPEAT: string;
					public static HTTP_AUTH_DIGEST_RE_ENABLED_ALGORITHMS: string;
					public static HTTP_AUTH_DIGEST_VALIDATE_PROXY: string;
					public static HTTP_AUTH_DIGEST_VALIDATE_SERVER: string;
					public static HTTP_AUTH_NTLM_DOMAIN: string;
					public static HTTP_KEEP_ALIVE: string;
					public static HTTP_KEEP_ALIVE_TIME_PROXY: string;
					public static HTTP_KEEP_ALIVE_TIME_SERVER: string;
					public static HTTP_MAX_CONNECTIONS: string;
					public static HTTP_MAX_REDIRECTS: string;
					public static HTTP_NON_PROXY_HOSTS: string;
					public static HTTP_PROXY_HOST: string;
					public static HTTP_PROXY_PORT: string;
					public static HTTPS_PROXY_HOST: string;
					public static HTTPS_PROXY_PORT: string;
					...
					public static JAVA_CONTENT_HANDLER_PKGS: string;
					...
					public static JAVA_LOCALE_USE_OLD_ISO_CODES: string;
					public static JAVA_NET_PREFER_IPV4_STACK: string;
					public static JAVA_NET_PREFER_IPV6_ADDRESSES: string;
					public static JAVA_NET_SOCKS_PASSWORD: string;
					public static JAVA_NET_SOCKS_USER_NAME: string;
					public static JAVA_NET_USE_SYSTEM_PROXIES: string;
					public static JAVA_NIO_CHANNELS_DEFAULT_THREAD_POOL_INITIAL_SIZE: string;
					public static JAVA_NIO_CHANNELS_DEFAULT_THREAD_POOL_THREAD_FACTORY: string;
					public static JAVA_NIO_CHANNELS_SPI_ASYNCHRONOUS_CHANNEL_PROVIDER: string;
					public static JAVA_NIO_CHANNELS_SPI_SELECTOR_PROVIDER: string;
					public static JAVA_NIO_FILE_SPI_DEFAULT_FILE_SYSTEM_PROVIDER: string;
					public static JAVA_PROPERTIES_DATE: string;
					public static JAVA_PROTOCOL_HANDLER_PKGS: string;
					public static JAVA_RMI_SERVER_CODEBASE: string;
					public static JAVA_RMI_SERVER_HOST_NAME: string;
					public static JAVA_RMI_SERVER_RANDOM_IDS: string;
					public static JAVA_RMI_SERVER_RMI_CLASS_LOADER_SPI: string;
					public static JAVA_RUNTIME_NAME: string;
					public static JAVA_RUNTIME_VERSION: string;
					public static JAVA_SECURITY_AUTH_LOGIN_CONFIG: string;
					public static JAVA_SECURITY_MANAGER: string;
					public static JAVA_SPECIFICATION_MAINTENANCE_VERSION: string;
					...
					public static JAVA_SYSTEM_CLASS_LOADER: string;
					public static JAVA_TIME_ZONE_DEFAULT_ZONE_RULES_PROVIDER: string;
					public static JAVA_UTIL_CONCURRENT_FORK_JOIN_POOL_COMMON_EXCEPTION_HANDLER: string;
					public static JAVA_UTIL_CONCURRENT_FORK_JOIN_POOL_COMMON_MAXIMUM_SPARES: string;
					public static JAVA_UTIL_CONCURRENT_FORK_JOIN_POOL_COMMON_PARALLELISM: string;
					public static JAVA_UTIL_CONCURRENT_FORK_JOIN_POOL_COMMON_THREAD_FACTORY: string;
					public static JAVA_UTIL_CURRENCY_DATA: string;
					public static JAVA_UTIL_LOGGING_CONFIG_CLASS: string;
					public static JAVA_UTIL_LOGGING_CONFIG_FILE: string;
					public static JAVA_UTIL_LOGGING_SIMPLE_FORMATTER_FORMAT: string;
					public static JAVA_UTIL_PREFS_PREFERENCES_FACTORY: string;
					public static JAVA_UTIL_PROPERTY_RESOURCE_BUNDLE_ENCODING: string;
					public static JAVA_VENDOR: string;
					public static JAVA_VENDOR_URL: string;
					public static JAVA_VENDOR_VERSION: string;
					public static JAVA_VERSION: string;
					public static JAVA_VERSION_DATE: string;
					...
					public static JAVA_XML_CONFIG_FILE: string;
					public static JAVAX_ACCESSIBILITY_ASSISTIVE_TECHNOLOGIES: string;
					public static JAVAX_NET_SSL_SESSION_CACHE_SIZE: string;
					public static JAVAX_RMI_SSL_CLIENT_ENABLED_CIPHER_SUITES: string;
					public static JAVAX_RMI_SSL_CLIENT_ENABLED_PROTOCOLS: string;
					public static JAVAX_SECURITY_AUTH_USE_SUBJECT_CREDS_ONLY: string;
					public static JAVAX_SMART_CARD_IO_TERMINAL_FACTORY_DEFAULT_TYPE: string;
					public static JDBC_DRIVERS: string;
					public static JDK_HTTP_AUTH_PROXYING_DISABLED_SCHEMES: string;
					public static JDK_HTTP_AUTH_TUNNELING_DISABLED_SCHEMES: string;
					public static JDK_HTTP_CLIENT_ALLOW_RESTRICTED_HEADERS: string;
					public static JDK_HTTP_CLIENT_AUTH_RETRY_LIMIT: string;
					public static JDK_HTTP_CLIENT_BUF_SIZE: string;
					public static JDK_HTTP_CLIENT_CONNECTION_POOL_SIZE: string;
					public static JDK_HTTP_CLIENT_CONNECTION_WINDOW_SIZE: string;
					public static JDK_HTTP_CLIENT_DISABLE_RETRY_CONNECT: string;
					public static JDK_HTTP_CLIENT_ENABLE_ALL_METHOD_RETRY: string;
					public static JDK_HTTP_CLIENT_ENABLE_PUSH: string;
					public static JDK_HTTP_CLIENT_HPACK_MAX_HEADER_TABLE_SIZE: string;
					public static JDK_HTTP_CLIENT_HTTP_CLIENT_LOG: string;
					public static JDK_HTTP_CLIENT_KEEP_ALIVE_TIMEOUT: string;
					public static JDK_HTTP_CLIENT_KEEP_ALIVE_TIMEOUT_H2: string;
					public static JDK_HTTP_CLIENT_MAX_FRAME_SIZE: string;
					public static JDK_HTTP_CLIENT_MAX_STREAMS: string;
					public static JDK_HTTP_CLIENT_RECEIVE_BUFFER_SIZE: string;
					public static JDK_HTTP_CLIENT_REDIRECTS_RETRY_LIMIT: string;
					public static JDK_HTTP_CLIENT_SEND_BUFFER_SIZE: string;
					public static JDK_HTTP_CLIENT_WEB_SOCKET_WRITE_BUFFER_SIZE: string;
					public static JDK_HTTP_CLIENT_WINDOW_SIZE: string;
					public static JDK_HTTP_SERVER_MAX_CONNECTIONS: string;
					public static JDK_HTTPS_NEGOTIATE_CBT: string;
					public static JDK_INCLUDE_IN_EXCEPTIONS: string;
					public static JDK_INTERNAL_HTTP_CLIENT_DISABLE_HOST_NAME_VERIFICATION: string;
					public static JDK_IO_PERMISSIONS_USE_CANONICAL_PATH: string;
					public static JDK_JNDI_LDAP_OBJECT_FACTORIES_FILTER: string;
					public static JDK_JNDI_OBJECT_FACTORIES_FILTER: string;
					public static JDK_JNDI_RMI_OBJECT_FACTORIES_FILTER: string;
					public static JDK_MODULE_MAIN: string;
					public static JDK_MODULE_MAIN_CLASS: string;
					public static JDK_MODULE_PATH: string;
					public static JDK_MODULE_UPGRADE_PATH: string;
					public static JDK_NET_UNIX_DOMAIN_TMPDIR: string;
					public static JDK_NET_URL_CLASS_PATH_SHOW_IGNORED_CLASS_PATH_ENTRIES: string;
					public static JDK_SERIAL_FILTER: string;
					public static JDK_SERIAL_FILTER_FACTORY: string;
					public static JDK_TLS_CLIENT_SIGNATURE_SCHEMES: string;
					public static JDK_TLS_NAMED_GROUPS: string;
					public static JDK_TLS_SERVER_SIGNATURE_SCHEMES: string;
					public static JDK_VIRTUAL_THREAD_SCHEDULER_MAXPOOLSIZE: string;
					public static JDK_VIRTUAL_THREAD_SCHEDULER_PARALLELISM: string;
					public static JDK_XML_CDATA_CHUNK_SIZE: string;
					public static JDK_XML_DTD_SUPPORT: string;
					public static JDK_XML_ELEMENT_ATTRIBUTE_LIMIT: string;
					public static JDK_XML_ENABLE_EXTENSION_FUNCTIONS: string;
					public static JDK_XML_ENTITY_EXPANSION_LIMIT: string;
					public static JDK_XML_ENTITY_REPLACEMENT_LIMIT: string;
					public static JDK_XML_IS_STANDALONE: string;
					public static JDK_XML_JDK_CATALOG_RESOLVE: string;
					public static JDK_XML_MAX_ELEMENT_DEPTH: string;
					public static JDK_XML_MAX_GENERAL_ENTITY_SIZE_LIMIT: string;
					public static JDK_XML_MAX_OCCUR_LIMIT: string;
					public static JDK_XML_MAX_PARAMETER_ENTITY_SIZE_LIMIT: string;
					public static JDK_XML_MAX_XML_NAME_LIMIT: string;
					public static JDK_XML_OVERRIDE_DEFAULT_PARSER: string;
					public static JDK_XML_RESET_SYMBOL_TABLE: string;
					public static JDK_XML_TOTAL_ENTITY_SIZE_LIMIT: string;
					public static JDK_XML_XSLTC_IS_STANDALONE: string;
					public static LINE_SEPARATOR: string;
					public static NATIVE_ENCODING: string;
					public static NETWORK_ADDRESS_CACHE_NEGATIVE_TTL: string;
					public static NETWORK_ADDRESS_CACHE_STALE_TTL: string;
					public static NETWORK_ADDRESS_CACHE_TTL: string;
					public static ORG_JCP_XML_DSIG_SECURE_VALIDATION: string;
					public static ORG_OPENJDK_JAVA_UTIL_STREAM_TRIPWIRE: string;
					...
					public static SOCKS_PROXY_HOST: string;
					public static SOCKS_PROXY_PORT: string;
					public static SOCKS_PROXY_VERSION: string;
					public static STDERR_ENCODING: string;
					public static STDOUT_ENCODING: string;
					public static SUN_NET_HTTP_SERVER_DRAIN_AMOUNT: string;
					public static SUN_NET_HTTP_SERVER_IDLE_INTERVAL: string;
					public static SUN_NET_HTTP_SERVER_MAX_IDLE_CONNECTIONS: string;
					public static SUN_NET_HTTP_SERVER_MAX_REQ_HEADERS: string;
					public static SUN_NET_HTTP_SERVER_MAX_REQ_TIME: string;
					public static SUN_NET_HTTP_SERVER_MAX_RSP_TIME: string;
					public static SUN_NET_HTTP_SERVER_NO_DELAY: string;
					public static SUN_SECURITY_KRB5_PRINCIPAL: string;
					public static USER_COUNTRY: string;
					public static USER_DIR: string;
					public static USER_EXTENSIONS: string;
					...
					public static USER_SCRIPT: string;
					public static USER_TIMEZONE: string;
					public static USER_VARIANT: string;
					public static getStdOutEncoding(): string;
					public static getJavaxAccessibilityAssistiveTechnologies(): string;
					public static getJavaRmiServerCodebase(): string;
					public static getJavaVendor(): string;
					public static getSunSecurityKrb5Principal(): string;
					public static getJavaNetUseSystemProxies(): string;
					public static getUserLanguage(): string;
					public static getJavaVersion(): string;
					public static getHttpMaxConnections(): string;
					public static getJdkHttpClientDisableRetryConnect(): string;
					public static getJavaNioChannelsSpiAsynchronousChannelProvider(): string;
					public static getFtpProxyPort(): string;
					public static getJdkJndiRmiObjectFactoriesFilter(): string;
					public static getJdkHttpClientKeepAliveTimeoutH2(): string;
					public static getSunNetHttpServerMaxReqHeaders(): string;
					public static getSocksProxyPort(): string;
					public static getOsVersion(): string;
					public static getJdkHttpAuthTunnelingDisabledSchemes(): string;
					public static getJdkHttpClientHttpClientLog(): string;
					public static getAppleAwtEnableTemplateImages(): string;
					public static getJavaRuntimeVersion(): string;
					public static getJdkHttpClientHpackMaxHeaderTableSize(): string;
					public static getSunNetHttpServerNoDelay(): string;
					public static getHttpKeepAlive(): string;
					public static getJdkXmlElementAttributeLimit(): string;
					public static getJavaContentHandlerPkgs(): string;
					public static getJavaxSecurityAuthUseSubjectCredsOnly(): string;
					public static getJavaUtilPrefsPreferencesFactory(): string;
					public static getJdkHttpClientMaxStreams(): string;
					public static getJdkXmlCdataChunkSize(): string;
					public static getJdkXmlMaxElementDepth(): string;
					public static getOrgJcpXmlDsigSecureValidation(): string;
					public static getHttpKeepAliveTimeProxy(): string;
					public static getHttpAuthDigestReenabledAlgorithms(): string;
					public static getJdkNetUrlClassPathShowIgnoredClassPathEntries(): string;
					...
					public static getJdkXmlEntityExpansionLimit(): string;
					public static getJavaNetSocksPassword(): string;
					public static getJdkNetUnixDomainTmpDir(): string;
					public static getJdkXmlEntityReplacementLimit(): string;
					public static getJdkXmlMaxXmlNameLimit(): string;
					public static getJdkTlsServerSignatureSchemes(): string;
					public static getJdkTlsNamedGroups(): string;
					public static getJdkHttpAuthProxyingDisabledSchemes(): string;
					public static getJavaxSmartCardIoTerminalFactoryDefaultType(): string;
					public static getFileSeparator(): string;
					public static getOrgOpenJdkJavaUtilStreamTripwire(): string;
					public static getJdkModuleUpgradePath(): string;
					public static getHttpProxyPort(): string;
					public static getHttpsProxyPort(): string;
					public static getJavaxRmiSslClientEnabledCipherSuites(): string;
					public static getSunNetHttpServerDrainAmount(): string;
					public static getJavaAwtHeadless(): string;
					public static getJavaSpecificationVendor(): string;
					public static getJavaVmInfo(): string;
					public static getJdkJndiLdapObjectFactoriesFilter(): string;
					public static getOsArch(): string;
					public static getSunNetHttpServerIdleInterval(): string;
					public static getJdbcDrivers(): string;
					public static getJdkHttpClientAuthRetryLimit(): string;
					public static getJdkXmlDtdSupport(): string;
					public static getJavaClassPath(): string;
					public static getJavaExtDirs(): string;
					public static getJdkVirtualThreadSchedulerParallelism(): string;
					public static getComSunNetHttpServerHttpServerProvider(): string;
					public static getJavaNioChannelsDefaultThreadPoolThreadFactory(): string;
					public static getJavaVmVersion(): string;
					public static getJdkJndiObjectFactoriesFilter(): string;
					/** @deprecated */
					public constructor();
					public static getJdkXmlJdkCatalogResolve(): string;
					public static getJdkHttpClientWebSocketWriteBufferSize(): string;
					public static getHttpAgent(): string;
					public static getNetworkAddressCacheTtl(): string;
					public static getJdkSerialFilter(): string;
					public static getSocksProxyVersion(): string;
					public static getJavaSecurityAuthLoginConfig(): string;
					public static getJavaTimeZoneDefaultZoneRulesProvider(): string;
					public static getNetworkAddressCacheNegativeTtl(): string;
					public static getJdkXmlIsStandalone(): string;
					public static getJavaUtilCurrencyData(): string;
					public static getJavaNioFileSpiDefaultFileSystemProvider(): string;
					public static getJdkHttpClientConnectionPoolSize(): string;
					public static getJavaSpecificationVersion(defaultValue: string): string;
					public static getJavaProtocolHandlerPkgs(): string;
					public static getPathSeparator(): string;
					public static getJavaHome(): string;
					public static getJdkHttpsNegotiateCbt(): string;
					public static getJavaUtilLoggingSimpleFormatterFormat(): string;
					public static getJavaVmSpecificationVendor(): string;
					public static getHttpNonProxyHosts(): string;
					public static getJavaSecurityManager(): string;
					public static getJavaNioChannelsSpiSelectorProvider(): string;
					public static getNetworkAddressCacheStaleTtl(): string;
					public static getJavaUtilConcurrentForkJoinPoolCommonParallelism(): string;
					public static getJavaCompiler(): string;
					public static getLineSeparator(defaultIfAbsent: any /* any*/): string;
					public static getUserRegion(): string;
					public static getJavaNetPreferIpv4Stack(): string;
					public static getJavaVmSpecificationVersion(): string;
					public static getJdkHttpClientAllowRestrictedHeaders(): string;
					public static getJavaPropertiesDate(): string;
					public static getJdkModuleMain(): string;
					public static getJavaxNetSslSessionCacheSize(): string;
					public static getUserHome(): string;
					public static getJdkXmlResetSymbolTable(): string;
					public static getJdkIoPermissionsUseCanonicalPath(): string;
					public static getJdkXmlTotalEntitySizeLimit(): string;
					public static getJavaUtilPropertyResourceBundleEncoding(): string;
					public static getJdkHttpClientEnablePush(): string;
					public static getJavaVendorUrl(): string;
					public static getJdkHttpClientKeepAliveTimeout(): string;
					public static getJavaxRmiSslClientEnabledProtocols(): string;
					public static getJavaSpecificationMaintenanceVersion(): string;
					public static getJavaUtilLoggingConfigClass(): string;
					public static getUserVariant(): string;
					public static getUserCountry(): string;
					public static getHttpAuthDigestValidateProxy(): string;
					public static getJdkHttpClientEnableAllMethodRetry(): string;
					public static getJavaXmlConfigFile(): string;
					public static getNativeEncoding(): string;
					public static getAwtToolkit(): string;
					public static getJdkInternalHttpClientDisableHostNameVerification(): string;
					public static getHttpKeepAliveTimeServer(): string;
					public static getJdkHttpClientBufSize(): string;
					public static getLong(key: string, defaultIfAbsent: any /* any*/): number;
					public static getJavaUtilConcurrentForkJoinPoolCommonExceptionHandler(): string;
					public static getFtpProxyHost(): string;
					public static getJdkHttpClientRedirectsRetryLimit(): string;
					public static getUserScript(): string;
					public static getHttpsProxyHost(): string;
					public static getBoolean(key: string, defaultIfAbsent: any /* any*/): boolean;
					public static getHttpProxyHost(): string;
					public static getOsName(): string;
					public static getJdkXmlEnableExtensionFunctions(): string;
					public static getUserDir(): string;
					public static getStdErrEncoding(): string;
					public static getHttpAuthDigestValidateServer(): string;
					public static getHttpAuthNtlmDomain(): string;
					public static getJdkHttpClientReceiveBufferSize(): string;
					public static getJavaAwtGraphicsenv(): string;
					public static getJdkXmlOverrideDefaultParser(): string;
					public static getComSunJndiLdapObjectTrustSerialData(): string;
					public static getJavaRmiServerRmiClassLoaderSpi(): string;
					public static getJavaSpecificationVersion(): string;
					public static getJdkHttpClientMaxFrameSize(): string;
					public static getJdkTlsClientSignatureSchemes(): string;
					public static getJavaEndorsedDirs(): string;
					public static getJavaNetPreferIpv6Addresses(): string;
					public static getJavaIoTmpdir(): string;
					public static getJavaAwtFonts(): string;
					public static getJdkXmlMaxOccurLimit(): string;
					public static getJavaUtilLoggingConfigFile(): string;
					public static getJavaLocaleProviders(): string;
					public static getJavaRmiServerRandomIds(): string;
					public static getJavaSpecificationName(): string;
					public static getProperty(property: string): string;
					public static getUserExtensions(): string;
					public static getJavaUtilConcurrentForkJoinPoolCommonThreadFactory(): string;
					public static getUserName(defaultValue: string): string;
					public static getJdkModuleMainClass(): string;
					public static getJdkHttpClientSendBufferSize(): string;
					public static getJdkIncludeInExceptions(): string;
					public static getJavaLibraryPath(): string;
					public static getSunNetHttpServerMaxRspTime(): string;
					public static getJavaVmSpecificationName(): string;
					public static getSunNetHttpServerMaxIdleConnections(): string;
					public static getJavaVmVendor(): string;
					public static getJdkVirtualThreadSchedulerMaxPoolSize(): string;
					public static getJdkSerialFilterFactory(): string;
					public static getJavaVersionDate(): string;
					public static getJavaNioChannelsDefaultThreadPoolInitialSize(): string;
					public static getFtpNonProxyHost(): string;
					public static getJdkHttpServerMaxConnections(): string;
					public static getJdkModulePath(): string;
					public static getFileEncoding(): string;
					public static getUserName(): string;
					public static getJavaVmName(): string;
					public static getJdkXmlMaxGeneralEntitySizeLimit(): string;
					public static getSunNetHttpServerMaxReqTime(): string;
					public static getJavaVendorVersion(): string;
					public static getJavaRuntimeName(): string;
					public static getJavaAwtPrinterjob(): string;
					public static getJavaUtilConcurrentForkJoinPoolCommonMaximumSpares(): string;
					public static getJdkHttpClientWindowSize(): string;
					public static getJdkHttpClientConnectionWindowSize(): string;
					public static getJdkXmlXsltcIsStandalone(): string;
					public static getJavaSystemClassLoader(): string;
					public static getJavaNetSocksUserName(): string;
					public static getJavaLocaleUseOldIsoCodes(): string;
					public static getJavaRmiServerHostName(): string;
					public static getSocksProxyHost(): string;
					public static getHttpMaxRedirects(): string;
					public static getLineSeparator(): string;
					public static getJdkXmlMaxParameterEntitySizeLimit(): string;
					public static getHttpAuthDigestCnonceRepeat(): string;
				}
			}
		}
	}
		...
		export module commons {
			export module lang3 {
				export class SystemUtils extends java.lang.Object {
					...
					public static IS_JAVA_22: boolean;
					public static IS_OS_AIX: boolean;
					public static IS_OS_ANDROID: boolean;
					...
					public static IS_OS_MAC_OSX_SONOMA: boolean;
				...
				export module arch {
					...
					export module Processor {
						...
						export class Type {
							...
							public static RISC_V: org.apache.commons.lang3.arch.Processor.Type;
		...
		export module commons {
			export module lang3 {
				export module builder {
					export abstract class AbstractSupplier<T, B, E>  extends org.apache.commons.lang3.function.FailableSupplier<any,any> {
						public static class: java.lang.Class<org.apache.commons.lang3.builder.AbstractSupplier<any,any,any>>;
						public constructor();
						public asThis(): any;
						public get(): any;
						public static nul(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
					}
				}
			}
		}
			...
			export module lang3 {
				export module builder {
					export class DiffBuilder<T>  extends org.apache.commons.lang3.builder.Builder<org.apache.commons.lang3.builder.DiffResult<any>> {
						...
						/** @deprecated */
						public constructor(left: any, right: any, style: org.apache.commons.lang3.builder.ToStringStyle, testObjectsEquals: boolean);
						public build(): any;
						...
						public static builder(): org.apache.commons.lang3.builder.DiffBuilder.Builder<any>;
						public append(fieldName: string, lhs: any, rhs: any): org.apache.commons.lang3.builder.DiffBuilder<any>;
						/** @deprecated */
						public constructor(left: any, right: any, style: org.apache.commons.lang3.builder.ToStringStyle);
						public append(fieldName: string, lhs: boolean, rhs: boolean): org.apache.commons.lang3.builder.DiffBuilder<any>;
						public append(fieldName: string, lhs: number[], rhs: number[]): org.apache.commons.lang3.builder.DiffBuilder<any>;
					}
					export module DiffBuilder {
						export class Builder<T>  extends java.lang.Object {
							public static class: java.lang.Class<org.apache.commons.lang3.builder.DiffBuilder.Builder<any>>;
							public constructor();
							public setTestObjectsEquals(testObjectsEquals: boolean): org.apache.commons.lang3.builder.DiffBuilder.Builder<T>;
							public setStyle(style: org.apache.commons.lang3.builder.ToStringStyle): org.apache.commons.lang3.builder.DiffBuilder.Builder<T>;
							public setToStringFormat(toStringFormat: string): org.apache.commons.lang3.builder.DiffBuilder.Builder<T>;
							public setLeft(left: T): org.apache.commons.lang3.builder.DiffBuilder.Builder<T>;
							public setRight(right: T): org.apache.commons.lang3.builder.DiffBuilder.Builder<T>;
							public build(): org.apache.commons.lang3.builder.DiffBuilder<T>;
						}
						export class SDiff<T>  extends org.apache.commons.lang3.builder.Diff<any> {
							public static class: java.lang.Class<org.apache.commons.lang3.builder.DiffBuilder.SDiff<any>>;
							public getValue(): any;
							public hashCode(): number;
							public static comparingByKey(cmp: java.util.Comparator<any>): java.util.Comparator<any>;
							public getLeft(): any;
			...
			export module lang3 {
				export module builder {
					export class ReflectionDiffBuilder<T>  extends org.apache.commons.lang3.builder.Builder<org.apache.commons.lang3.builder.DiffResult<any>> {
						...
						public build(): org.apache.commons.lang3.builder.DiffResult<any>;
						/** @deprecated */
						public setExcludeFieldNames(...excludeFieldNames: string[]): org.apache.commons.lang3.builder.ReflectionDiffBuilder<any>;
						/** @deprecated */
						public constructor(left: any, right: any, style: org.apache.commons.lang3.builder.ToStringStyle);
						public getExcludeFieldNames(): string[];
						public static builder(): org.apache.commons.lang3.builder.ReflectionDiffBuilder.Builder<any>;
						public build(): any;
					}
					export module ReflectionDiffBuilder {
						export class Builder<T>  extends java.lang.Object {
							public static class: java.lang.Class<org.apache.commons.lang3.builder.ReflectionDiffBuilder.Builder<any>>;
							public constructor();
							public setDiffBuilder(diffBuilder: org.apache.commons.lang3.builder.DiffBuilder<T>): org.apache.commons.lang3.builder.ReflectionDiffBuilder.Builder<T>;
							public build(): org.apache.commons.lang3.builder.ReflectionDiffBuilder<T>;
							public setExcludeFieldNames(...excludeFieldNames: string[]): org.apache.commons.lang3.builder.ReflectionDiffBuilder.Builder<T>;
						}
					}
				}
			}
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export module concurrent {
					export abstract class AbstractConcurrentInitializer<T, E>  extends org.apache.commons.lang3.concurrent.ConcurrentInitializer<any> {
						public static class: java.lang.Class<org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer<any,any>>;
						public initialize(): any;
						public constructor();
						public close(): void;
						public getTypedException(param0: java.lang.Exception): any;
						public get(): any;
						public isInitialized(): boolean;
						public static nul(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
					}
					export module AbstractConcurrentInitializer {
						export abstract class AbstractBuilder<I, T, B, E>  extends org.apache.commons.lang3.builder.AbstractSupplier<any,any,any> {
							public static class: java.lang.Class<org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer.AbstractBuilder<any,any,any,any>>;
							public constructor();
							public get(): any;
							public setInitializer(initializer: org.apache.commons.lang3.function.FailableSupplier<any,any>): any;
							public static nul(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
							public getCloser(): org.apache.commons.lang3.function.FailableConsumer<any,any>;
							public getInitializer(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
							public setCloser(closer: org.apache.commons.lang3.function.FailableConsumer<any,any>): any;
						}
					}
				}
			}
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export module concurrent {
					export class AtomicInitializer<T>  extends org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer<any,org.apache.commons.lang3.concurrent.ConcurrentException> {
						public static class: java.lang.Class<org.apache.commons.lang3.concurrent.AtomicInitializer<any>>;
						public constructor();
						public getTypedException(e: java.lang.Exception): org.apache.commons.lang3.concurrent.ConcurrentException;
						public static builder(): org.apache.commons.lang3.concurrent.AtomicInitializer.Builder<any,any>;
						public getTypedException(param0: java.lang.Exception): any;
						public get(): any;
						public isInitialized(): boolean;
					}
					export module AtomicInitializer {
						export class Builder<I, T>  extends org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer.AbstractBuilder<any,any,org.apache.commons.lang3.concurrent.AtomicInitializer.Builder<any,any>,org.apache.commons.lang3.concurrent.ConcurrentException> {
							public static class: java.lang.Class<org.apache.commons.lang3.concurrent.AtomicInitializer.Builder<any,any>>;
							public constructor();
							public get(): any;
							public static nul(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
						}
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export module concurrent {
					export class AtomicSafeInitializer<T>  extends org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer<any,org.apache.commons.lang3.concurrent.ConcurrentException> {
						public static class: java.lang.Class<org.apache.commons.lang3.concurrent.AtomicSafeInitializer<any>>;
						public constructor();
						public getTypedException(e: java.lang.Exception): org.apache.commons.lang3.concurrent.ConcurrentException;
						public static builder(): org.apache.commons.lang3.concurrent.AtomicSafeInitializer.Builder<any,any>;
						public getTypedException(param0: java.lang.Exception): any;
						public get(): any;
						public isInitialized(): boolean;
					}
					export module AtomicSafeInitializer {
						export class Builder<I, T>  extends org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer.AbstractBuilder<any,any,org.apache.commons.lang3.concurrent.AtomicSafeInitializer.Builder<any,any>,org.apache.commons.lang3.concurrent.ConcurrentException> {
							public static class: java.lang.Class<org.apache.commons.lang3.concurrent.AtomicSafeInitializer.Builder<any,any>>;
							public constructor();
							public get(): any;
							public static nul(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
						}
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export module concurrent {
					export class BackgroundInitializer<T>  extends org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer<any,java.lang.Exception> {
						...
						public isInitialized(): boolean;
						public static builder(): org.apache.commons.lang3.concurrent.BackgroundInitializer.Builder<any,any>;
						public start(): boolean;
						public isStarted(): boolean;
						public setExternalExecutor(externalExecutor: java.util.concurrent.ExecutorService): void;
						public getTypedException(e: java.lang.Exception): java.lang.Exception;
					}
					export module BackgroundInitializer {
						export class Builder<I, T>  extends org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer.AbstractBuilder<any,any,org.apache.commons.lang3.concurrent.BackgroundInitializer.Builder<any,any>,java.lang.Exception> {
							public static class: java.lang.Class<org.apache.commons.lang3.concurrent.BackgroundInitializer.Builder<any,any>>;
							public constructor();
							public get(): any;
							public setExternalExecutor(externalExecutor: java.util.concurrent.ExecutorService): org.apache.commons.lang3.concurrent.BackgroundInitializer.Builder<any,any>;
							public static nul(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
						}
				...
				export module concurrent {
					...
					export module BasicThreadFactory {
						export class Builder extends org.apache.commons.lang3.builder.Builder<org.apache.commons.lang3.concurrent.BasicThreadFactory> {
							...
							public constructor();
							public namingPattern(namingPattern: string): org.apache.commons.lang3.concurrent.BasicThreadFactory.Builder;
							public daemon(daemon: boolean): org.apache.commons.lang3.concurrent.BasicThreadFactory.Builder;
							public uncaughtExceptionHandler(exceptionHandler: java.lang.Thread.UncaughtExceptionHandler): org.apache.commons.lang3.concurrent.BasicThreadFactory.Builder;
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export module concurrent {
					export class ConcurrentInitializer<T>  extends org.apache.commons.lang3.function.FailableSupplier<any,org.apache.commons.lang3.concurrent.ConcurrentException> {
						 ...
						 */
						public constructor(implementation: {
							nul(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
							get(): any;
							lambda$static$0(): any;
							"<clinit>"(): void;
						});
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export module concurrent {
					export class LazyInitializer<T>  extends org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer<any,org.apache.commons.lang3.concurrent.ConcurrentException> {
						public static class: java.lang.Class<org.apache.commons.lang3.concurrent.LazyInitializer<any>>;
						public static builder(): org.apache.commons.lang3.concurrent.LazyInitializer.Builder<any,any>;
						public constructor();
						public getTypedException(e: java.lang.Exception): org.apache.commons.lang3.concurrent.ConcurrentException;
						public getTypedException(param0: java.lang.Exception): any;
						public get(): any;
					...
					export module LazyInitializer {
						export class Builder<I, T>  extends org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer.AbstractBuilder<any,any,org.apache.commons.lang3.concurrent.LazyInitializer.Builder<any,any>,org.apache.commons.lang3.concurrent.ConcurrentException> {
							public static class: java.lang.Class<org.apache.commons.lang3.concurrent.LazyInitializer.Builder<any,any>>;
							public constructor();
							public get(): any;
							public static nul(): org.apache.commons.lang3.function.FailableSupplier<any,any>;
						}
				...
				export module event {
					...
					export module EventListenerSupport {
						export class ProxyInvocationHandler extends java.lang.Object implements java.lang.reflect.InvocationHandler {
							...
							public handle(t: java.lang.Throwable): void;
							public constructor(this$0: org.apache.commons.lang3.function.FailableConsumer<java.lang.Throwable,java.lang.IllegalAccessException>);
			...
			export module lang3 {
				export module exception {
					export class ExceptionUtils extends java.lang.Object {
						...
						public static throwUnchecked(throwable: java.lang.Throwable): java.lang.Throwable;
						...
						public static asRuntimeException(throwable: java.lang.Throwable): java.lang.RuntimeException;
						/** @deprecated */
			...
			export module lang3 {
				export module function {
					export class Consumers extends java.lang.Object {
						...
						public static accept(consumer: any /* any*/, object: any): void;
			...
			export module lang3 {
				export module function {
					export class FailableFunction<T, R, E>  extends java.lang.Object {
						 ...
						 */
						public constructor(implementation: {
							function(_function_: org.apache.commons.lang3.function.FailableFunction<any,any,any>): org.apache.commons.lang3.function.FailableFunction<any,any,any>;
						...
						public static function(_function_: org.apache.commons.lang3.function.FailableFunction<any,any,any>): org.apache.commons.lang3.function.FailableFunction<any,any,any>;
					}
				}
			}
		}
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export module function {
					export class FailableSupplier<T, E>  extends java.lang.Object {
	...
	export module apache {
		export module commons {
			export module lang3 {
				export module function {
					export class Functions extends java.lang.Object {
						public static class: java.lang.Class<org.apache.commons.lang3.function.Functions>;
						public static function(_function_: any /* any*/): any /* any*/;
						public static apply(_function_: any /* any*/, object: any): any;
					}
				}
			}
		}
			...
			export module lang3 {
				export module reflect {
					export class MethodUtils extends java.lang.Object {
						...
						public static getMethodObject(cls: java.lang.Class<any>, name: string, ...parameterTypes: java.lang.Class<any>[]): java.lang.reflect.Method;
			...
			export module lang3 {
				export module stream {
					export class LangCollectors extends java.lang.Object {
						...
						public static collect(collector: java.util.stream.Collector, ...array: any[]): any;
					}
			...
			export module lang3 {
				export module stream {
					export class Streams extends java.lang.Object {
						...
						public static failableStream(value: any): org.apache.commons.lang3.stream.Streams.FailableStream<any>;
						public static nonNull(array: any): java.util.stream.Stream;
						public static failableStream(...values: any[]): org.apache.commons.lang3.stream.Streams.FailableStream<any>;
						...
						public static nonNull(...array: any[]): java.util.stream.Stream;
						public static toArray(elementType: java.lang.Class<any>): java.util.stream.Collector;
						/** @deprecated */
						public constructor();
...
declare module org {
	export module apache {
		export module commons {
			export module lang3 {
				export module time {
					export abstract class AbstractFormatCache<F>  extends java.lang.Object {
						public static class: java.lang.Class<org.apache.commons.lang3.time.AbstractFormatCache<any>>;
					...
					export module AbstractFormatCache {
						export class ArrayKey extends java.lang.Object {
							public static class: java.lang.Class<org.apache.commons.lang3.time.AbstractFormatCache.ArrayKey>;
							public hashCode(): number;
							public equals(obj: any): boolean;
						}
					}
			...
			export module lang3 {
				export module time {
					export class CalendarUtils extends java.lang.Object {
						...
						public static getInstance(): org.apache.commons.lang3.time.CalendarUtils;
			...
			export module lang3 {
				export module time {
					export class StopWatch extends java.lang.Object {
						...
						public getStartInstant(): java.time.Instant;
						public resume(): void;
						...
						public getSplitDuration(): java.time.Duration;
						public getSplitNanoTime(): number;
						public start(): void;
						public getNanoTime(): number;
						public isStarted(): boolean;
						public constructor(message: string);
						public getStopInstant(): java.time.Instant;
						/** @deprecated */
...
//org.apache.commons.lang3.AppendableJoiner:1
...
//org.apache.commons.lang3.builder.AbstractSupplier:3
...
//org.apache.commons.lang3.builder.DiffBuilder.SDiff:1
...
//org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer:2
//org.apache.commons.lang3.concurrent.AbstractConcurrentInitializer.AbstractBuilder:4
//org.apache.commons.lang3.concurrent.AbstractFutureProxy:1
//org.apache.commons.lang3.concurrent.AtomicInitializer:1
//org.apache.commons.lang3.concurrent.AtomicInitializer.Builder:2
//org.apache.commons.lang3.concurrent.AtomicSafeInitializer:1
//org.apache.commons.lang3.concurrent.AtomicSafeInitializer.Builder:2
//org.apache.commons.lang3.concurrent.BackgroundInitializer:1
//org.apache.commons.lang3.concurrent.BackgroundInitializer.Builder:2
...
//org.apache.commons.lang3.concurrent.LazyInitializer.Builder:2
...
//org.apache.commons.lang3.time.AbstractFormatCache:1
