...
declare module com {
	export module afollestad {
		export module materialdialogs {
			export class DefaultRvAdapter extends android.support.v7.widget.RecyclerView.Adapter<com.afollestad.materialdialogs.DefaultRvAdapter.DefaultVH> {
			...
			export module DefaultRvAdapter {
				export class DefaultVH implements android.view.View.OnClickListener, android.view.View.OnLongClickListener {
		...
		export module materialdialogs {
			...
			export module MaterialDialog {
				export class Builder extends java.lang.Object {
					...
					public layoutManager: android.support.v7.widget.RecyclerView.LayoutManager;
					...
					public adapter(adapter: android.support.v7.widget.RecyclerView.Adapter<any>, layoutManager: android.support.v7.widget.RecyclerView.LayoutManager): com.afollestad.materialdialogs.MaterialDialog.Builder;
		...
		export module materialdialogs {
			export module internal {
				export class MDRootLayout extends android.view.ViewGroup {
					...
					public static canRecyclerViewScroll(view: android.support.v7.widget.RecyclerView): boolean;
