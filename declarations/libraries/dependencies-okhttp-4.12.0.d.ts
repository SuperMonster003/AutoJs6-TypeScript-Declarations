...
declare module okhttp3 {
	export class Cache extends java.lang.Object implements java.io.Closeable, java.io.Flushable {
		...
		public constructor(directory: java.io.File, maxSize: number, param2: okhttp3.internal.io.FileSystem);
...
declare module okhttp3 {
	...
	export module Request {
		export class Builder extends java.lang.Object {
			...
			public setTags$okhttp(_set_: java.util.Map<java.lang.Class<any>,any>): void;
...
declare module okhttp3 {
	...
	export module Response {
		export class Builder extends java.lang.Object {
			...
			public initExchange$okhttp(deferredTrailers: okhttp3.internal.connection.Exchange): void;
...
declare module okhttp3 {
	export module internal {
		export class Util extends java.lang.Object {
			...
			public static closeQuietly($this$closeQuietly: java.net.ServerSocket): void;
			public static indexOfFirstNonAsciiWhitespace($this$indexOfFirstNonAsciiWhitespace: string, startIndex: number, endIndex: number): number;
			public static indexOfControlOrNonAscii($this$indexOfControlOrNonAscii: string): number;
			public static asFactory($this$asFactory: okhttp3.EventListener): okhttp3.EventListener.Factory;
			public static toHostHeader($this$toHostHeader: okhttp3.HttpUrl, includeDefaultPort: boolean): string;
			public static trimSubstring($this$trimSubstring: string, startIndex: number, endIndex: number): string;
			public static toLongOrDefault($this$toLongOrDefault: string, defaultValue: number): number;
			public static addIfAbsent($this$addIfAbsent: java.util.List<any>, element: any): void;
			public static wait($this$wait: any): void;
			public static closeQuietly($this$closeQuietly: java.net.Socket): void;
			public static delimiterOffset($this$delimiterOffset: string, delimiter: string, startIndex: number, endIndex: number): number;
			public static assertThreadDoesntHoldLock($this$assertThreadDoesntHoldLock: any): void;
			public static indexOfNonWhitespace($this$indexOfNonWhitespace: string, startIndex: number): number;
			public static concat($this$concat: string[], value: string): string[];
			public static intersect($this$intersect: string[], other: string[], comparator: java.util.Comparator<any>): string[];
			public static headersContentLength($this$headersContentLength: okhttp3.Response): number;
			...
			public static filterList($this$filterList: java.lang.Iterable<any>, predicate: kotlin.jvm.functions.Function1): java.util.List<any>;
			public static and($this$and: number, mask: number): number;
			public static toImmutableList($this$toImmutableList: java.util.List<any>): java.util.List<any>;
			public static isSensitiveHeader(name: string): boolean;
			public static isCivilized($this$isCivilized: okhttp3.internal.io.FileSystem, file: java.io.File): boolean;
			public static readFieldOrNull(instance: any, fieldType: java.lang.Class<any>, fieldName: string): any;
			public static indexOf($this$indexOf: string[], value: string, comparator: java.util.Comparator<string>): number;
			public static canReuseConnectionFor($this$canReuseConnectionFor: okhttp3.HttpUrl, other: okhttp3.HttpUrl): boolean;
			public static isHealthy($this$isHealthy: java.net.Socket, source: okio.BufferedSource): boolean;
			public static readBomAsCharset($this$readBomAsCharset: okio.BufferedSource, default: java.nio.charset.Charset): java.nio.charset.Charset;
			public static closeQuietly($this$closeQuietly: java.io.Closeable): void;
			public static toHeaderList($this$toHeaderList: okhttp3.Headers): java.util.List<okhttp3.internal.http2.Header>;
			public static toImmutableMap($this$toImmutableMap: java.util.Map<any,any>): java.util.Map<any,any>;
			public static checkOffsetAndCount(arrayLength: number, param1: number, offset: number): void;
			public static notifyAll($this$notifyAll: any): void;
			public static checkDuration(name: string, duration: number, param2: java.util.concurrent.TimeUnit): number;
			public static toHeaders($this$toHeaders: java.util.List<okhttp3.internal.http2.Header>): okhttp3.Headers;
			public wait(): void;
			public static discard($this$discard: okio.Source, timeout: number, timeUnit: java.util.concurrent.TimeUnit): boolean;
			public static parseHexDigit($this$parseHexDigit: string): number;
			public static skipAll($this$skipAll: okio.Buffer, b: number): number;
			public notify(): void;
			...
			public static delimiterOffset($this$delimiterOffset: string, delimiters: string, startIndex: number, endIndex: number): number;
			public static skipAll($this$skipAll: okio.Source, duration: number, timeUnit: java.util.concurrent.TimeUnit): boolean;
			public static peerName($this$peerName: java.net.Socket): string;
			public static assertThreadHoldsLock($this$assertThreadHoldsLock: any): void;
			public static immutableListOf(...elements: any[]): java.util.List<any>;
			public static readMedium($this$readMedium: okio.BufferedSource): number;
			public static writeMedium($this$writeMedium: okio.BufferedSink, medium: number): void;
			public static hasIntersection($this$hasIntersection: string[], other: string[], comparator: java.util.Comparator<any>): boolean;
			public static format(format: string, ...args: any[]): string;
			public wait(millis: number): void;
			public wait(param0: number, param1: number): void;
			public static toNonNegativeInt($this$toNonNegativeInt: string, defaultValue: number): number;
			public notifyAll(): void;
			public static notify($this$notify: any): void;
			public static indexOfLastNonAsciiWhitespace($this$indexOfLastNonAsciiWhitespace: string, startIndex: number, endIndex: number): number;
			public static withSuppressed($this$withSuppressed: java.lang.Exception, suppressed: java.util.List<any>): java.lang.Throwable;
			public static canParseAsIpAddress($this$canParseAsIpAddress: string): boolean;
		}
	}
}
	...
	export module internal {
		export module cache {
			export class DiskLruCache extends java.lang.Object implements java.io.Closeable, java.io.Flushable {
				...
				public constructor(fileSystem: okhttp3.internal.io.FileSystem, directory: java.io.File, appVersion: number, valueCount: number, maxSize: number, param5: okhttp3.internal.concurrent.TaskRunner);
				public isClosed(): boolean;
				public size(): number;
	...
	export module internal {
		export module connection {
			export class RealCall extends java.lang.Object implements okhttp3.Call {
				...
				public setConnectionToCancel(_set_: okhttp3.internal.connection.RealConnection): void;
	...
	export module internal {
		export module connection {
			export class RealConnection extends okhttp3.internal.http2.Http2Connection.Listener implements okhttp3.Connection {
				...
				public protocol(): okhttp3.Protocol;
				public trackFailure$okhttp(call: okhttp3.internal.connection.RealCall, e: java.io.IOException): void;
				...
				public setIdleAtNs$okhttp(_set_: number): void;
			...
			export module android {
				...
				export module SocketAdapter {
					export class DefaultImpls extends java.lang.Object {
						...
						public static trustManager($this: okhttp3.internal.platform.android.SocketAdapter, sslSocketFactory: javax.net.ssl.SSLSocketFactory): javax.net.ssl.X509TrustManager;
						public static matchesSocketFactory($this: okhttp3.internal.platform.android.SocketAdapter, sslSocketFactory: javax.net.ssl.SSLSocketFactory): boolean;
					}
				}
			}
		}
