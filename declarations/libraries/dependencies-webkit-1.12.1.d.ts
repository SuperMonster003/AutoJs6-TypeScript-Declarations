...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class PrefetchOperationResultBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.PrefetchOperationResultBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.PrefetchOperationResultBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class PrefetchParamsBoundaryInterface extends java.lang.Object {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.PrefetchParamsBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.PrefetchParamsBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					getAdditionalHeaders(): java.util.Map<string,string>;
					getNoVarySearchHint(): string;
				});
				public constructor();
				public getAdditionalHeaders(): java.util.Map<string,string>;
				public getNoVarySearchHint(): string;
			}
		}
	}
}
...
declare module org {
	export module chromium {
		export module support_lib_boundary {
			export class PrefetchStatusCodeBoundaryInterface extends java.lang.Object implements java.lang.annotation.Annotation {
				public static class: java.lang.Class<org.chromium.support_lib_boundary.PrefetchStatusCodeBoundaryInterface>;
				/**
				 * Constructs a new instance of the org.chromium.support_lib_boundary.PrefetchStatusCodeBoundaryInterface interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
				 */
				public constructor(implementation: {
					equals(param0: any): boolean;
					hashCode(): number;
		...
		export module support_lib_boundary {
			export class ProfileBoundaryInterface extends java.lang.Object {
				...
				public constructor(implementation: {
					...
					getGeoLocationPermissions(): android.webkit.GeolocationPermissions;
					getServiceWorkerController(): android.webkit.ServiceWorkerController;
					prefetchUrl(param0: string, param1: android.webkit.ValueCallback<java.lang.reflect.InvocationHandler>): void;
					prefetchUrl(param0: string, param1: java.lang.reflect.InvocationHandler, param2: android.webkit.ValueCallback<java.lang.reflect.InvocationHandler>): void;
					cancelPrefetch(param0: string): void;
					clearPrefetch(param0: string, param1: android.webkit.ValueCallback<java.lang.reflect.InvocationHandler>): void;
				});
				public constructor();
				public prefetchUrl(param0: string, param1: java.lang.reflect.InvocationHandler, param2: android.webkit.ValueCallback<java.lang.reflect.InvocationHandler>): void;
				public clearPrefetch(param0: string, param1: android.webkit.ValueCallback<java.lang.reflect.InvocationHandler>): void;
				public prefetchUrl(param0: string, param1: android.webkit.ValueCallback<java.lang.reflect.InvocationHandler>): void;
				public getServiceWorkerController(): android.webkit.ServiceWorkerController;
				public cancelPrefetch(param0: string): void;
				public getName(): string;
				public getGeoLocationPermissions(): android.webkit.GeolocationPermissions;
				public getCookieManager(): android.webkit.CookieManager;
				public getWebStorage(): android.webkit.WebStorage;
