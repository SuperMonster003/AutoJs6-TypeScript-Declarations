...
This roadmap tracks the work needed to synchronize this repository with the local AutoJs6 runtime APIs under:

```text
D:\idea-projects\AutoJs6\app\src\main\java\org\autojs\autojs\runtime\api\augment
```

The current cycle is a compatibility refresh, not a cleanup release. No existing `.d.ts` file is scheduled for deletion unless a later source audit proves that the corresponding API is no longer reachable at runtime.
...
- Known parser/type errors inside `aj6-main-app.d.ts` are accepted generator artifacts and should not block augment-module declaration work.
- Regeneration currently also refreshes `declarations/android.d.ts`, `declarations/libraries.d.ts`, and generated resource declarations such as `aj6-r-string.d.ts`.
- Validation for generated support files should exclude `aj6-main-app.d.ts` unless the generator itself is being fixed.
...
- 2026-06-15: Ran a scoped syntax check for generated support declarations excluding `aj6-main-app.d.ts`: `android.d.ts`, `libraries.d.ts`, `aj6-r-string.d.ts`, `aj6-gradle-wrapper.d.ts`, `aj6-int-jvm-npm.d.ts`, and `aj6-declarations.d.ts`.
...
- [ ] Check that `index.d.ts` can be consumed from a fresh project.
...
```shell
cmd /c tsc --noEmit --skipLibCheck --noResolve --lib es2020 declarations/android.d.ts declarations/libraries.d.ts declarations/autojs6/aj6-int-images.d.ts declarations/autojs6/aj6-int-colors.d.ts declarations/autojs6/aj6-int-zip.d.ts declarations/autojs6/aj6-int-sysprops.d.ts declarations/autojs6/aj6-int-nanoid.d.ts declarations/autojs6/aj6-int-pinyin4j.d.ts declarations/autojs6/aj6-int-converter.d.ts declarations/autojs6/aj6-int-formatter.d.ts declarations/autojs6/aj6-int-jsox.d.ts declarations/autojs6/aj6-int-init.d.ts docs/smoke/key-globals-smoke.ts
```
